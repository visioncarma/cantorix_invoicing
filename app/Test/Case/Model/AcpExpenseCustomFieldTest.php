<?php
App::uses('AcpExpenseCustomField', 'Model');

/**
 * AcpExpenseCustomField Test Case
 *
 */
class AcpExpenseCustomFieldTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AcpExpenseCustomField = ClassRegistry::init('AcpExpenseCustomField');
	}
 ...
 */
	public function tearDown() {
		unset($this->AcpExpenseCustomField);
