<?php
App::uses('InvInventoryCustomValue', 'Model');

/**
 * InvInventoryCustomValue Test Case
 *
 */
class InvInventoryCustomValueTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->InvInventoryCustomValue = ClassRegistry::init('InvInventoryCustomValue');
	}
 ...
 */
	public function tearDown() {
		unset($this->InvInventoryCustomValue);
