<?php
App::uses('SbsSubscriberTax', 'Model');

/**
 * SbsSubscriberTax Test Case
 *
 */
class SbsSubscriberTaxTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SbsSubscriberTax = ClassRegistry::init('SbsSubscriberTax');
	}
