<?php
App::uses('CpnLanguage', 'Model');

/**
 * CpnLanguage Test Case
 *
 */
class CpnLanguageTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CpnLanguage = ClassRegistry::init('CpnLanguage');
	}
