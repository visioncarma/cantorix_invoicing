<?php
App::uses('SbsSubscriberTaxGroupMapping', 'Model');

/**
 * SbsSubscriberTaxGroupMapping Test Case
 *
 */
class SbsSubscriberTaxGroupMappingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SbsSubscriberTaxGroupMapping = ClassRegistry::init('SbsSubscriberTaxGroupMapping');
	}
 ...
 */
	public function tearDown() {
		unset($this->SbsSubscriberTaxGroupMapping);
