<?php
App::uses('SbsSubscriberTaxGroup', 'Model');

/**
 * SbsSubscriberTaxGroup Test Case
 *
 */
class SbsSubscriberTaxGroupTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SbsSubscriberTaxGroup = ClassRegistry::init('SbsSubscriberTaxGroup');
	}
 ...
 */
	public function tearDown() {
		unset($this->SbsSubscriberTaxGroup);
