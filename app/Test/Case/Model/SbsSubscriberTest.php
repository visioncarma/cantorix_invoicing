<?php
App::uses('SbsSubscriber', 'Model');

/**
 * SbsSubscriber Test Case
 *
 */
class SbsSubscriberTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SbsSubscriber = ClassRegistry::init('SbsSubscriber');
	}
