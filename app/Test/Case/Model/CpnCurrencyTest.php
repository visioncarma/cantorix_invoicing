<?php
App::uses('CpnCurrency', 'Model');

/**
 * CpnCurrency Test Case
 *
 */
class CpnCurrencyTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CpnCurrency = ClassRegistry::init('CpnCurrency');
	}
