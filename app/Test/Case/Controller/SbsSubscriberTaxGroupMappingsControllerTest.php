<?php
App::uses('SbsSubscriberTaxGroupMappingsController', 'Controller');

/**
 * SbsSubscriberTaxGroupMappingsController Test Case
 *
 */
class SbsSubscriberTaxGroupMappingsControllerTest extends ControllerTestCase {
