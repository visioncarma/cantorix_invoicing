<?php
App::uses('CpnRecurringInvoicesController', 'Controller');

/**
 * CpnRecurringInvoicesController Test Case
 *
 */
class CpnRecurringInvoicesControllerTest extends ControllerTestCase {
