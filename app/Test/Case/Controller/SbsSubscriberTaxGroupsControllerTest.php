<?php
App::uses('SbsSubscriberTaxGroupsController', 'Controller');

/**
 * SbsSubscriberTaxGroupsController Test Case
 *
 */
class SbsSubscriberTaxGroupsControllerTest extends ControllerTestCase {
