<?php
App::uses('CpnSubscriptionPlansController', 'Controller');

/**
 * CpnSubscriptionPlansController Test Case
 *
 */
class CpnSubscriptionPlansControllerTest extends ControllerTestCase {
