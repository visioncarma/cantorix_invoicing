<?php
App::uses('SbsSubscriberTaxesController', 'Controller');

/**
 * SbsSubscriberTaxesController Test Case
 *
 */
class SbsSubscriberTaxesControllerTest extends ControllerTestCase {
