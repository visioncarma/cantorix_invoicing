<?php
App::uses('SbsSubscriberCpnCurrencyMappingsController', 'Controller');

/**
 * SbsSubscriberCpnCurrencyMappingsController Test Case
 *
 */
class SbsSubscriberCpnCurrencyMappingsControllerTest extends ControllerTestCase {
