...
<div class="page-content">
	<div class="page-header">
        ...
        <div class="col-lg-2 paddingleftrightzero">
             <?php echo $this->Html->link('<i class="icon-arrow-left icon-on-left"></i>Back', array('action' => 'index',$plan,$company,$subscriberName,'page:'.$page), array('update'=>'#content','class' => 'btn btn-sm btn-success pull-right addbutton','escape'=>FALSE));?>
        </div>
	</div>
    <!-- /.page-header -->
