		...
		<div class="row">
			...
			<div class="col-xs-12 col-lg-12 col-sm-9 col-md-9 pricing-span-body pricing-span-bodypaddingneed">
				...
				<div class="left width100 margin20top">
					...
					?>	
					<div class="left paddingleftrightzero col-lg-6 col-md-6 col-xs-12 footerbutton">
						<?php echo $this->Js->link('Upgrade Subscription',array('controller'=>'subscribers','action'=>'upgradeSubscription'),array('class'=>'col-lg-12 btn btn-sm btn-success pull-left upgradeblue button_mobile','update'=>'#pageContent'));?>
					</div>
					<?php }?>
					<?php }?>
					...
					<?php if($plan['CpnSubscriptionPlan']['type'] == 'Unlimited') {
							...
							if($usersCount > $standardPlan['CpnSubscriptionPlan']['no_of_staffs'] && $standardPlan['CpnSubscriptionPlan']['no_of_staffs'] != -1) {
								echo '<div class="left paddingleftrightzero col-lg-6 col-md-6 col-xs-12 footerbutton">
										<button data-target="#downgrade" data-toggle="modal" class="col-lg-12 btn btn-sm btn-success pull-left upgradeblue  button_mobile">
											Downgrade Subscription
										</button>
									</div>';
						 ...
						 ?>
					<div class="left paddingleftrightzero padingleftneed col-lg-6 col-md-6 col-sm-6 col-xs-12 footerbutton">
						<?php echo $this->Js->link('Downgrade Subscription',array('controller'=>'subscribers','action'=>'downgradeSubscription'),array('class'=>'col-lg-12 btn btn-sm btn-success pull-left upgradeblue button_mobile','update'=>'#pageContent'));?>
					</div>
					<?php }?>
					<?php }?>
					
					<div class="left paddingleftrightzero padingleftneed marginneedtop col-lg-6 col-md-6 col-sm-6 col-xs-12 footerbutton nopaddingmobile">
						<button data-target="#cancelsubscription" data-toggle="modal" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 btn btn-sm btn-success pull-left cancelredd widthfulmobcance button_mobile">
							Cancel Subscription
						</button>
					</div>
				</div>
			 ...
			 <div class="center 14pfont paddingbottom">
			 	<?php 
			 		if($plan['SbsSubscriber']['status'] == 'Active') {
			 			...
			 			echo 'You\'ve already requested for <strong> cancellation </strong> of your subscription!';
         ...
         <div class="model-body-inner-content">  
			 ...
			 <div class="center 14pfont paddingbottom">
			 	<?php 
			 		...
			 		} elseif(!empty($invoices) && ($invoices['CpnSubscriberInvoiceDetail']['payment_status'] == 'Pending' || $invoices['CpnSubscriberInvoiceDetail']['payment_status'] == 'Failed' || $invoices['CpnSubscriberInvoiceDetail']['outstanding_balance'] > 0)) {
			 			echo 'Your invoice is due please clear the invoice dues to downgrade the plan.';
			 		} elseif (!empty($downgradeRequest)) {
			 		    echo 'You have already requested for downgrade your plan.';
			 		}
				?> 
