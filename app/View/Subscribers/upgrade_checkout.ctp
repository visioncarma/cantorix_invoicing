...
<div class="widget-main">
	<div class="payment-box">
		...
		<p>Note:</p>
		<p> 1. Your prorate amount has been calculated on the remaining days to the recurring payment date. Any prorate amount less than <span class="bold">$<?php echo $amount_threshold; ?></span> has been discarded.</p>
		<p> 2. The monthly recurring charge for <i><?php echo $subscriptionType; ?></i> subscription plan would be applied on the <?php echo date('jS',strtotime($profilestartdate));?> of next month.</p>
	</div>
	<?php echo $this -> Form -> create('paymentForm',array('url' => array('controller' => 'users', 'action' => 'changeSubscriptionCheckout','subscribers','changeSubscription','upgrade'),'id'=>'paymentForm')); ?>
	<?php
