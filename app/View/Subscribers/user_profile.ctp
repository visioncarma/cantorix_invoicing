		...
		<div class="page-header">
          ...
          <div class="row paddingtop100">
                    ...
                    <div class="profilethumpnail profile-picture">
                      ...
                      <img class="img-responsive" src="<?php echo $imgLink.$webroot_name.$user_detail['User']['profile_picture_path'];?>"  alt="profilepic"/>
                      <?php }else{
  ...
  $(document).ready(function(){ 
	  $("#UserUserProfileForm").validate({
		 ...
		 messages:{			 
			 'data[User][current_password]': {
				...
				password_mach : 'Current password is incorrect.'
			},			
	...
	<?php if(isset($_SERVER['HTTPS'] )  && $_SERVER['HTTPS'] != 'off' ){
	 ...
	 $.validator.addMethod("password_mach",function(value,element){			
		 var x= $.ajax({
		    url: "<?php echo $protocol_final.'://'.$_SERVER['SERVER_NAME'].$this->webroot;?>subscribers/password_check",
		    type: 'GET',
		    async: false,
