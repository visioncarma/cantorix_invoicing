					...
					<div class="col-xs-12">
                      ...
                      <div class="form-horizontal customerform" role="form">
                      	 	...
                      	 	<!--<div class="clearfix form-actions margintopzero addformbutton padding0 addUC-btn">-->
                      	 		<div class="form-group footerbutton">
							<div class="col-md-offset-2 col-sx-offset-0 col-md-4 text_right_custom">
								
								<?php echo $this->Form->button('<i class="icon-ok bigger-110"></i>Save',array('class'=>'btn btn-info forgetval button_mobile','escape'=>false));?>
							...
							<div class="form-group relative">
                                ...
                                <div class="col-sm-5 col-xs-12 col-lg-3 labelerror countrybilling max-height max-width choosen_width">
                                  <?php echo $this->Form->input('cpn_currency_id',array('div'=>FALSE,'label'=>FALSE,'data-live-search' => 'true','class'=>'col-sm-5 col-xs-12 col-lg-3 form-control invdrop selectitem','data-placeholder'=>"Select a Currency", 'options'=>array(''=>'',$currencies),'value'=>$defaultCurrenyId));?>                                                 
							    </div>
                            </div>
					        <!--<div class="space-4"></div>-->
							<div class="form-group">
                                ...
                                <div class="col-sm-5 col-xs-12 col-lg-3 countrybilling max-height max-width choosen_width">
                                    <?php echo $this->Form->input('cpn_language_id',array('div'=>FALSE,'label'=>FALSE,'data-live-search' => 'true','class'=>'col-xs-12 col-sm-5 form-control invdrop selectitem','data-placeholder'=>"Select a Language", 'options'=>array(''=>'',$languages),'value'=>$defaultLanguageId));?>  
                                </div>
                            </div>
                            <div class="form-group">
					        ...
					        <!--<div class="space-4"></div>-->
                            <div class="form-group">
                                <label class="col-xs-5 col-sm-3 col-lg-2 control-label no-padding-right">Send Invoices By</label>        
                                <div class="col-sm-5 col-xs-6 col-lg-3">
                                    <label>
                             ...
                             <div class="form-group relative">
                                ...
                                <div class="col-sm-5 col-xs-12 col-lg-3 labelerror choosen_width">
                                    <?php echo $this->Form->input('sbs_subscriber_payment_term_id',array('div'=>FALSE,'label'=>FALSE,'class'=>'col-xs-12 col-sm-5 form-control invdrop selectitem','data-placeholder'=>"Select a Payment Terms", 'options'=>array(''=>'',$payment_terms),'default'=>$paymentTermDefault['SbsSubscriberPaymentTerm']['id']));?>  
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 col-xs-12 col-lg-3">
                                   <?php echo $this->Form->input('Contact1.mobile',array('div'=>FALSE,'label'=>FALSE,'class'=>'col-xs-12 col-sm-5 form-control','onkeypress' => "return isNumberKey(event)"));?>  
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 col-xs-12 col-lg-3">
                                    <?php echo $this->Form->input('Contact1.home_phone',array('div'=>FALSE,'label'=>FALSE,'class'=>'col-xs-12 col-sm-5 form-control','onkeypress' => "return isNumberKey(event)"));?>  
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 col-xs-12 col-lg-3">
                                     <?php echo $this->Form->input('Contact1.work_phone',array('div'=>FALSE,'label'=>FALSE,'class'=>'col-xs-12 col-sm-5 form-control','onkeypress' => "return isNumberKey(event)"));?>  
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-3 col-lg-2 control-label no-padding-right">Primary</label>        
                                <div class="col-sm-5 col-xs-9 col-lg-3">
                                    <label>
                                          <?php echo $this->Form->input('Contact1.is_primary',array('type'=>'checkbox','div'=>FALSE,'label'=>FALSE,'class'=>'ace ace1 primarycheck','checked'=>'checked'));?>  
                                           <span class="lbl"></span>
                                     </label>
                            ...
                            <div class="col-sm-12 paddingtopbottom2 col-xs-12 nopaddingleft nopaddingright">
                               <!-- <div class="col-sm-5 nopaddingleft nopaddingright"></div>-->
                                ...
                                <label class="addcontact">Add More Customer Details</label>
                            </div>
                            </div>                            
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-5 col-xs-12 col-lg-3 countrybilling max-height max-width">
                                    <?php echo $this->Form->input('billing_country',array('div'=>FALSE,'label'=>FALSE,'data-live-search'=>'true','class'=>'col-xs-12 col-sm-5 billcountry form-control selectpicker','options'=>array(''=>'Select',$countries)));?>  
                                </div>
                            </div>
                            ...
                            <div class="form-group optionselect">
                                <label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right"> Country </label>        
                                <div class="col-sm-5 col-xs-12 col-lg-3 countrybilling max-height max-width">
                                   <?php echo $this->Form->input('shipping_country',array('div'=>FALSE,'label'=>FALSE,'data-live-search'=>'true','class'=>'col-xs-12 col-sm-5 shipcountry form-control selectpicker','options'=>array(''=>'Select',$countries)));?>  
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-actions margintopzero paddingtopzero addformbutton paddingtop25 padding-left0 paddingrightzero">
							<div class="col-md-offset-2 col-sx-offset-0 col-md-4 text_right_custom footerbutton">
...
$(document).ready(function(){
	...
	<?php if(isset($_SERVER['HTTPS'] )  && $_SERVER['HTTPS'] != 'off' ){
		...
		$.validator.addMethod("orgExist",function(value,element){			
		 var x= $.ajax({
		    url: "<?php echo $protocol_final.'://'.$_SERVER['SERVER_NAME'].$this->webroot;?>customers/orgcheck",
		    type: 'GET',
		    async: false,
		...
		$.validator.addMethod("email2",function(value,element){			
		 var x= $.ajax({
		    url: "<?php echo $protocol_final.'://'.$_SERVER['SERVER_NAME'].$this->webroot;?>customers/EmailExist",
		    type: 'GET',
		    async: false,
...
$(document).ready(function(){
	...
	$('body').on('click','.primarycheck',function(){
	 ...
	 $('.addbutton').click(function(){
		   ...
		   a1++;
		   $('.forvalue').val(a1);
		   $('.newcontactadd').append('<div class="col-sm-12 col-xs-12 paddingleftrightzero newaddedcontact"><div class="col-sm-12 contactdetails paddingleftrightzero"><h5>Contact '+a1+' Details</h5></div><div class="form-group"><label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right"> Contact Name <em class="red">∗</em> </label><div class="col-xs-12 col-sm-5 col-lg-3"><input type="text" class="col-xs-12 col-sm-5 form-control" name="data[Contact'+a+'][name]"></div></div><div class="form-group"><label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right"> Contact Surname <em class="red">∗</em> </label><div class="col-xs-12 col-sm-5 col-lg-3"><input type="text" class="col-xs-12 col-sm-5 form-control" name="data[Contact'+a+'][sur_name]"></div></div><div class="form-group"><label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right"> Contact Email <em class="red">∗</em> </label><div class="col-xs-12 col-sm-5 col-lg-3"><input type="text"  class="col-xs-12 col-sm-5 form-control" name="data[Contact'+a+'][email]"></div></div><div class="form-group"><label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right"> Mobile </label><div class="col-xs-12 col-sm-5 col-lg-3"><input type="text" class="col-xs-12 col-sm-5 form-control" name="data[Contact'+a+'][mobile]" onkeypress = "return isNumberKey(event)"></div></div><div class="form-group"><label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right"> Home Phone </label><div class="col-xs-12 col-sm-5 col-lg-3"><input type="text"  class="col-xs-12 col-sm-5 form-control" name="data[Contact'+a+'][home_phone]" onkeypress = "return isNumberKey(event)"></div></div><div class="form-group"><label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right"> Work Phone </label><div class="col-xs-12 col-sm-5 col-lg-3"><input type="text" class="col-xs-12 col-sm-5 form-control" name="data[Contact'+a+'][work_phone]" onkeypress = "return isNumberKey(event)"></div></div><div class="form-group"><label class="col-xs-3 col-sm-3 col-lg-2 control-label no-padding-right">Primary</label><div class="col-xs-9 col-sm-3 col-lg-3"><label><input id="Contact'+a+'IsPrimary_" type="hidden" value="0" name="data[Contact'+a+'][is_primary]"><input type="checkbox"  id="Contact'+a+'IsPrimary" class="ace ace2 primarycheck" name="data[Contact'+a+'][is_primary]"><span class="lbl"></span> </label> <span class="help-button customer-help-button blue_back" data-rel="popover" data-trigger="hover" data-placement="right" data-content="select to make it your primary contact" >?</span></div></div><div class="form-group"><label class="col-xs-12 col-sm-3 col-lg-2 control-label no-padding-right">Delete Contact</label><div class="col-sm-5 col-xs-12 col-lg-3"><i class="icon-trash bigger-120 red delete pointer deletecontact" title="Delete Contact" data-original-title="delete"></i></div></div></div></div>');
