...
<div class="page-content">
	<div class="page-header">
		<!--<h1> Edit Role </h1>-->
		<div class="headernew col-lg-4 col-md-5 col-sm-4 col-xs-4 ">
			Edit Role
		</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="table-responsive table-responsivenoscroll">
				<div class="row margin-twenty-zero filterdivmob margin0">
					<div class="form-group margin-bottom-zero role-form-group">
						<label class="col-sm-2 control-label no-padding-right no-padding-left col-xs-3 col-lg-1" for="form-field-1">Role name</label>
				...
				<table id="sample-table-1" class="table table-striped table-bordered table-hover table_fixed_new role">
					<thead>
						<tr>
					...
					<tbody>
						...
						<tr class="child-<?php echo $menu['Aco']['id'];?>">
							<?php 
								$disabled = FALSE;
								if($childMenu['Aco']['alias'] == 'Manage Roles' || $childMenu['Aco']['alias'] == 'Manage Users') {
									if($groupName['Aro']['alias'] == 'Admin') {
										$disabled = TRUE;
				...
				<div class="row">
					...
					<div class="col-sm-12 col-xs-12 col-xs-12 marginbottomm footerbutton">
						<?php echo $this->Html->link('<i class="icon-remove bigger-110"></i>Cancel',array('action'=>'manageUsergroup'),array('class'=>'btn pull-right margin-left-15 btn-inverse button_mobile','escape'=>FALSE));?>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$.validator.addMethod("checkEmailAvailability",function(value,element){				
			var x= $.ajax({
			    url: "<?php echo $protocol_final.'://'.$_SERVER['SERVER_NAME'].$this->webroot;?>usergroups/checkRole/<?php echo $groupName['Aro']['id']?>",
			    type: 'POST',
			    async: false,
