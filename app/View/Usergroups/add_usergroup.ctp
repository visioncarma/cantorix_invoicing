	...
	<div class="row">
		<div class="col-xs-12">
			<div class="table-responsive table-responsivenoscroll">
				...
				<h3 class="header smaller lighter blue bold col-xs-12 paddingmobile5">Select Module Access</h3>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$.validator.addMethod("checkEmailAvailability",function(value,element){				
			var x= $.ajax({
			    url: "<?php echo $protocol_final.'://'.$_SERVER['SERVER_NAME'].$this->webroot;?>usergroups/checkRole/",
			    type: 'POST',
			    async: false,
