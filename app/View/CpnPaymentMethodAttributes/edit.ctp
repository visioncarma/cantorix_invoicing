...
<?php echo $this->Form->create('CpnPaymentMethodAttribute'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cpn Payment Method Attribute'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CpnPaymentMethodAttribute.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CpnPaymentMethodAttribute.id'))); ?></li>
