...
?>
<?php if($data['AcrClientInvoice']['email_template'] == 'credit_product_classic'):?>
                          ...
                          <table style="width:100%; height:100%;" align="right">
                            ...
                            <tr>
                                <td style="text-align: right;padding-right: 15px;">
                                    ...
                                    <span style="font-weight:bold;font-family:Arial;"><?php echo $data['AcrClientInvoice']['credit_no'];?></span>
                                </td>
                            </tr> 
                          </table>    
                        </td>
...
<?php if($data['AcrClientInvoice']['email_template'] == 'credit_product_modern'):?>
                          ...
                          <table style="width:100%; height:100%;" align="left">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span style="font-weight:bold;font-family:Arial;"><?php if($data['AcrClientInvoice']['reference_no']){ echo $data['AcrClientInvoice']['reference_no'];}else { echo ''; }?></span>
                                </td>
                            </tr> 
                            <tr>
                                <td>
...
<?php if($data['AcrClientInvoice']['email_template'] == 'credit_service_classic'):?>
...
<?php if($data['AcrClientInvoice']['email_template'] == 'credit_service_modern'):?>
	<!doctype html>
