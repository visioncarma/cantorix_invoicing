<div class="sbsSubscriberTaxes index">
	<h2><?php echo __('Sbs Subscriber Taxes'); ?></h2>
	...
	<?php foreach ($sbsSubscriberTaxes as $sbsSubscriberTax): ?>
	<tr>
		<td><?php echo h($sbsSubscriberTax['SbsSubscriberTax']['id']); ?>&nbsp;</td>
		<td><?php echo h($sbsSubscriberTax['SbsSubscriberTax']['name']); ?>&nbsp;</td>
		<td><?php echo h($sbsSubscriberTax['SbsSubscriberTax']['code']); ?>&nbsp;</td>
		<td><?php echo h($sbsSubscriberTax['SbsSubscriberTax']['percent']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $sbsSubscriberTax['SbsSubscriberTax']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $sbsSubscriberTax['SbsSubscriberTax']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $sbsSubscriberTax['SbsSubscriberTax']['id']), null, __('Are you sure you want to delete # %s?', $sbsSubscriberTax['SbsSubscriberTax']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
