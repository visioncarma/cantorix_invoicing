...
<div class="row marginleftrightzero borderon">
	<div class="row marginleftrightzero">
		...
		<span class="right bold">
			...
			<?php echo $this->Number->currency($subTotal,$defaultCurrencyCode);?>
...
<div class="row marginleftrightzero borderon">
	...
	<div class="row marginleftrightzero">
		...
		<span class="right bold statusopn"><?php echo $this->Number->currency($invoicedCurrencyAmount,$invoicedCurrencyCode);?></span>
		<?php echo $this->Form->hidden('AcrClientInvoice.invoicetotal',array('value'=>$invoicedCurrencyAmount))?>
		<?php echo $this->Form->hidden('AcrClientInvoice.invoice_currency_code',array('value'=>$invoicedCurrencyCode));?>
	</div>
</div>
<div class="row marginleftrightzero ">
	<div class="row marginleftrightzero">
	...
	<div class="row marginleftrightzero">
		...
		<span class="right  bold statusopn">
			...
			<?php echo $this->Form->hidden('AcrClientInvoice.subscribertotalEditQuote',array('value'=>$finalProduct));?>
			<?php echo $this->Number->currency($finalProduct,$defaultCurrencyCode);?>
		</span>
	</div>
</div>
