...
<div class="page-content">
	...
	<!-- page heaqder-->
	<?php echo $this -> Form -> create('AcrClientInvoice', array('class' => 'form-horizontal formdetails', 'role' => 'form','url'=>array('controller'=>'AcrClientInvoices','action'=>'edit',$invoiceData['AcrClientInvoice']['id']))); ?>
	...
	<div class="row marginleftrightzero">
			<div class="col-lg-8 paddingleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero relative">
						...
						<div class="col-xs-12 col-sm-3 col-lg-6 marginleftrightzero paddingleftrightzero labelerror countrybilling max-height max-width choosen_width">
							...
							<?php echo $this -> Form -> input('acr_client_id', array('id' => 'clientId', 'div' => false, 'label' => false, 'options' => array('' => '', $customer), 'data-live-search' => 'true', 'class' => 'invdrop form-control', 'data-placeholder' => "Customer List", 'default' => $invoiceData['AcrClientInvoice']['acr_client_id']));
							...
							?>
							<?php
							$this -> Js -> get('#clientId') -> event('change', $this -> Js -> request(array('controller' => 'acr_client_invoices', 'action' => 'calculateTotal'), array('update' => '#calculateFinal', 'async' => true, 'dataExpression' => true, 'method' => 'post', 'data' => $this -> Js -> serializeForm(array('isForm' => false, 'inline' => true)))));
							?>
						</div>
					</div>
				</div>
				<div class="row marginleftrightzero" id = "currencyDiv">
					<div class="form-group  marginleftrightzero">
						...
						<div class="col-xs-12 col-sm-3 col-lg-2 marginleftrightzero paddingleftrightzero countrybilling max-height max-width">
							<?php echo $this -> Form -> hidden('defaultCurrencyId', array('value' => $defaultCurrency)); ?>
							<?php echo $this -> Form -> input('cpn_currency_id', array('id' => 'invoiceCurrencySelect', 'div' => false, 'label' => false, 'options' => array('' => 'Select Currency', $currencyList), 'default' => $defaultCurrency, 'data-live-search' => 'true', 'class' => 'form-control selectpicker', 'default' => $invoicedCurrency, 'disabled' => 'disabled'));
							...
							<?php
							$this -> Js -> get('#invoiceCurrencySelect') -> event('change', $this -> Js -> request(array('controller' => 'acr_client_invoices', 'action' => 'calculateTotal'), array('update' => '#calculateFinal', 'async' => true, 'dataExpression' => true, 'method' => 'post', 'data' => $this -> Js -> serializeForm(array('isForm' => false, 'inline' => true)))));
						?>
						</div>
						...
						<div id = "invoiceCurrency">
							...
							<div class="col-xs-12 col-sm-1 col-lg-2 marginleftrightzero paddingleftrightzero">
								...
								$this -> Js -> get('#conversionValue') -> event('change', $this -> Js -> request(array('controller' => 'acr_client_invoices', 'action' => 'calculateTotal'), array('update' => '#calculateFinal', 'async' => true, 'dataExpression' => true, 'method' => 'post', 'data' => $this -> Js -> serializeForm(array('isForm' => false, 'inline' => true)))));
								?>
							</div>
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-xs-12 col-sm-3 col-lg-3 marginleftrightzero paddingleftrightzero">
							...
							<?php echo $this->Form->input('AcrClientInvoice.invoiced_date',array('id'=>'invoice-date','div'=>false,'label'=>false,'type'=>'text','class'=>'form-control date-picker','data-date-format'=>str_ireplace($dbFormat, $scriptFormat, $dateFormat),'readonly'=>'readonly','value'=>date($dateFormat,strtotime($invoiceData['AcrClientInvoice']['invoiced_date']))))?>
				...
				<div class="row marginleftrightzero" >
					<div class="form-group marginleftrightzero">
						...
						<?php
							if ($invoiceData['AcrClientInvoice']['due_date']) {
								echo $this -> Form -> input('due_date', array('div' => false, 'label' => false, 'type' => 'text', 'class' => 'form-control', 'disabled' => 'disabled', 'default' => date($dateFormat, strtotime($invoiceData['AcrClientInvoice']['due_date']))));
							} else {
								...
								<div class="form-group borderline marginleftrightzero">
									<div class="row marginleftrightzero">
										<div class="col-sm-12 col-xs-12 no-padding-right no-padding-left">
											...
											<div class="col-sm-7 col-xs-7 no-padding-right bold no-padding-left " >
												<?php
												if ($contactPersonName) {echo $contactPersonName;
												} else { echo '<font color ="red"> Not Available</font>';
												}
											?>
											</div>
										</div>
									...
									<div class="row marginleftrightzero">
										<div class="col-sm-12 col-xs-12 no-padding-right no-padding-left">
											...
											<div class="col-sm-7 col-xs-7 control-label no-padding-right bold no-padding-left " >
												<?php
												if ($contactSurName) {echo $contactSurName;
												} else { echo '<font color ="red"> Not Available</font>';
												}
											?>
											</div>
									...
									<div class="row marginleftrightzero">
										<div class="col-sm-12 col-xs-12 no-padding-right no-padding-left">
											...
											<div class="col-sm-7 col-xs-7 control-label no-padding-right bold no-padding-left wordwrap" >
												<?php
												if ($contactEmail) {echo $contactEmail;
												} else { echo '<font color ="red"> Not Available</font>';
												}
											?>
											</div>
								...
								<div class="form-group borderline marginleftrightzero">
									<div class="row marginleftrightzero">
										<div class="col-sm-12 col-xs-12 no-padding-right no-padding-left">
											...
											<div class="col-sm-7 col-xs-7 control-label no-padding-right bold no-padding-left " >
												<?php
												if ($contactMobile) {echo $contactMobile;
												} else { echo '<font color ="red"> Not Available</font>';
												}
											?>
											</div>
								...
								<div class="form-group  marginleftrightzero borderline">
									<div class="row marginleftrightzero">
										<div class="col-sm-12 col-xs-12 no-padding-right no-padding-left">
											...
											<div class="col-sm-7 col-xs-7 control-label no-padding-right bold no-padding-left " >
												<?php
												if ($contactHomePhone) {echo $contactHomePhone;
												} else { echo '<font color ="red"> Not Available</font>';
												}
											?>
											</div>
								...
								<div class="form-group  marginleftrightzero lastrow">
									<div class="row marginleftrightzero">
										<div class="col-sm-12 col-xs-12 no-padding-right no-padding-left">
											...
											<div class="col-sm-7 col-xs-7 control-label no-padding-right bold no-padding-left " >
												<?php
												if ($contactWorkPhone) {echo $contactWorkPhone;
												} else { echo '<font color ="red"> Not Available</font>';
												}
											?>
											</div>
		...
		<!--   start table part   -->
			...
			<?php echo $this -> Form -> hidden('AcrClientInvoice.inventory_Old.' . $detailVal['AcrInvoiceDetail']['id'], array('value' => $detailVal['AcrInvoiceDetail']['id'])); ?>
				<div class="table-small-view  new-table-small  new_table_small_view new_table_small_view_new new-table-small" id = "inventoryUpdateSelect-<?php echo $detailVal['AcrInvoiceDetail']['id']?>">
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group filed-left drop-down marginleftrightzero form-dropdown margin-bottom-zero" id = "td-inventoryUpdateSelect-<?php echo $detailVal['AcrInvoiceDetail']['id']?>">
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								<?php echo $this->Form->input('AcrClientInvoice.description.'.$detailVal['AcrInvoiceDetail']['id'],array('div'=>false,'label'=>false,'class'=>'col-xs-10','type'=>'textarea','rows'=>'2','placeholder'=>'Inventory description','value'=>$detailVal['AcrInvoiceDetail']['inventory_description']));?>
							</div>
						</div>
					</div>
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							...
							<div class="col-xs-10 marginleftrightzero paddingleftrightzero ">
								<?php echo $this->Form->hidden('AcrClientInvoice.quantity_old.'.$detailVal['AcrInvoiceDetail']['id'],array('value'=>$detailVal['AcrInvoiceDetail']['quantity']));?>
									<?php echo $this->Form->input('AcrClientInvoice.quantity.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'quantity-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'label'=>false,'class'=>'form-control inputwidth text-right','type'=>'text','value'=>$detailVal['AcrInvoiceDetail']['quantity']));
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								...
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero ">
									<?php echo $this->Form->input('AcrClientInvoice.unit_rate.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'rate-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'label'=>false,'class'=>'form-control inputwidth text-right','type'=>'text','value'=>$detailVal['AcrInvoiceDetail']['unit_rate']));
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero ">
									<?php echo $this->Form->input('AcrClientInvoice.discount_percent.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'discount-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'label'=>false,'class'=>'form-control inputwidth text-right','type'=>'text','onkeyup'=>'this.value = minmax(this.value, 0, 100)', 'value'=>$detailVal['AcrInvoiceDetail']['discount_percent']));
							...
							<div class="form-group filed-left drop-down marginleftrightzero form-dropdown margin-bottom-zero">
								...
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero choosen_width">
									<?php if($detailVal['AcrInvoiceDetail']['sbs_subscriber_tax_group_id']){
										...
										<?php echo $this->Form->input('AcrClientInvoice.tax_inventory.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'tax-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'label'=>false,'class'=>'invdrop','data-placeholder'=>"Select Tax",'options'=>array(''=>'',$taxList),'default'=>$defaultTaxId));
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								...
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero " id = "lineTotal-<?php echo $detailVal['AcrInvoiceDetail']['id']?>">
									<?php echo $this->Form->input('AcrClientInvoice.line_total.'.$detailVal['AcrInvoiceDetail']['id'],array('div'=>false,'label'=>false,'class'=>'form-control inputwidth text-right','type'=>'text','disabled'=>'disabled','value'=>$detailVal['AcrInvoiceDetail']['line_total']));?>
								</div>
	                        </div>
						</div>
					</div>
			...
			<?php /*echo $this->Form->create('addInventory',array('id'=>'addInventory','role'=>'form','class'=>'form-horizontal popup'));*/?>
				...
				$(document).ready(function(){
					...
					$('.close-submit2').click(function(evt){
				    	 //alert('Works');
				    	 var value10 = $.trim($(".env-name-<?php echo $detailVal['AcrInvoiceDetail']['id']?>").val());
				    	 if(value10.length === 0) {
				    	 	$('.popup-error1').show();
				    	 	evt.preventDefault();
					        $('#field').value();
					     ...
					     var value12 = $.trim($(".env-price-<?php echo $detailVal['AcrInvoiceDetail']['id']?>").val());
				    	 if(value12.length === 0) {
				    	 	$('.popup-error2').show();
				    	 	evt.preventDefault();
					        $('#field').value();
				    	 ...
				    	 var value13 = $.trim($(".env-qty-<?php echo $detailVal['AcrInvoiceDetail']['id']?>").val());
				    	 if(value13.length === 0) {
				    	 	$('.popup-error4').show();
				    	 	evt.preventDefault();
					        $('#field').value();
               ...
               <div class="col-sm-12 col-xs-12 col-md-12 no-padding-right no-padding-left subtotal" id = "calculateFinal"> 
                ...
                <div class="row marginleftrightzero borderon padding_right5 padding_left_zero_subtotal">
                 ...
                 <div class="row marginleftrightzero padding_right5 padding_left12_subtotal_row padding_right11_subtotal_row">
                   ...
                   <span class="right bold statusopn">
                   		<?php echo $this->Number->currency($invoiceData['AcrClientInvoice']['invoice_total'],$invoiceData['AcrClientInvoice']['invoice_currency_code']);?>
                ...
                <div class="row marginleftrightzero padding_right5 padding_left_zero_subtotal">
                 ...
                 <div class="row marginleftrightzero padding_right5 padding_left12_subtotal_row padding_right11_subtotal_row">
                   ...
                   <span class="right  bold statusopn">
                   		<?php echo $this->Number->currency($invoiceData['AcrClientInvoice']['func_currency_total'],$defaultCurrencyCode);?>
           		...
           		<div class="row marginleftrightzero">
           			<div class="form-group marginleftrightzero">
           				...
           				<div class="col-sm-10 marginleftrightzero paddingleftrightzero">
           					<?php echo $this->Form->input('terms',array('div'=>false,'label'=>false,'class'=>'termsandconditions width100','rows'=>'6','cols'=>'30','type'=>'textarea','value'=>$invoiceData['AcrClientInvoice']['term_conditions']))?>
           				</div>
           			</div>
           		</div>
           		<div class="row marginleftrightzero">
           			<div class="form-group marginleftrightzero">
           				...
           				<div class="col-sm-10 marginleftrightzero paddingleftrightzero">
           					<?php echo $this->Form->input('note',array('div'=>false,'label'=>false,'class'=>'termsandconditions width100','rows'=>'6','cols'=>'30','type'=>'textarea','value'=>$invoiceData['AcrClientInvoice']['notes']))?>
           				</div>
           			</div>
           		</div>
           </div>
		   ...
		   <div class="row marginleftrightzero paddingbottom20 footerbutton">
			<div class="clearfix form-actions margintopzero paddingtopzero no-padding-left no-padding-right">
				<div class="col-md-offset-3 col-md-6">
					...
					<?php echo  $this->Form->button(__('<i class="icon-save bigger-110"></i> Save Invoice'),array('url'=>array('controller'=>'acr_client_invoices','action'=>'edit',$detailVal['AcrInvoiceDetail']['id']),'div'=>false,'class' => 'btn btn-info saveQuote button_mobile','name'=>'Save Invoice','value'=>'1'));?>	
