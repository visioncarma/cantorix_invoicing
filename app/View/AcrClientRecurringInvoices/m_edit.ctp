	...
	<div class="row marginleftrightzero">
			<div class="col-lg-8 paddingleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-xs-12 col-sm-3 col-lg-6 marginleftrightzero paddingleftrightzero choosen_width">
							<?php echo $this -> Form -> input('invoice_status', array('div' => false, 'label' => false, 'class' => 'invdrop form-control', 'data-placeholder' => "Select Status", 'options' => array('' => 'Select Status', 'Draft' => 'Draft', 'Open' => 'Open'), 'default' => $invoiceData['AcrClientInvoice']['status'])); ?>
						</div>
					</div>
				</div>
				<?php endif; ?>-->
				...
				<div class="row marginleftrightzero" id = "currencyDiv">
					<div class="form-group  marginleftrightzero">
						...
						<div class="col-xs-12 col-sm-3 col-lg-2 marginleftrightzero paddingleftrightzero countrybilling max-height max-width choosen_width">
							...
							<?php echo $this->Form->input('cpn_currency_id',array('id'=>'invoiceCurrencySelect','div'=>false,'label'=>false,'options'=>array(''=>'',$currencyList),'default'=>$defaultCurrency,'data-live-search' => 'true','data-placeholder'=>"Select Currency",'class'=>'form-control invdrop','default'=>$invoicedCurrency,'disabled'=>'disabled'));
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero relative">
						...
						<div class="col-xs-12 col-sm-3 col-lg-3 marginleftrightzero paddingleftrightzero labelerror" id = "paymentTerm">
				...
				<div class="row marginleftrightzero">
					<div class="form-group  marginleftrightzero width100">
				...
				<div class="row marginleftrightzero relative starterror">
					<div class="form-group  marginleftrightzero">
		...
		<!--   start table part   -->
			...
			<?php echo $this->Form->hidden('AcrClientInvoice.inventory_Old.'.$detailVal['AcrInvoiceDetail']['id'],array('value'=>$detailVal['AcrInvoiceDetail']['id']));?>
				<div class="table-small-view  new-table-small  new_table_small_view new_table_small_view_new" id = "inventoryUpdateSelect-<?php echo $detailVal['AcrInvoiceDetail']['id']?>">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group filed-left drop-down marginleftrightzero form-dropdown margin-bottom-zero" id = "td-inventoryUpdateSelect-<?php echo $detailVal['AcrInvoiceDetail']['id']?>">
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero choosen_width" >
									<?php echo $this->Form->input('AcrClientInvoice.inventory.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'inventory-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'data-live-search'=>'true','label'=>false,'class'=>'invdrop form-control','data-placeholder'=>"Select inventroy",'options'=>array(''=>'','-1'=>'Non Inventory Item',$inventoryList),'default'=>$detailVal['AcrInvoiceDetail']['inv_inventory_id']));
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							...
							<div class="col-xs-10 marginleftrightzero paddingleftrightzero ">
								<?php echo $this->Form->hidden('AcrClientInvoice.quantity_old.'.$detailVal['AcrInvoiceDetail']['id'],array('value'=>$detailVal['AcrInvoiceDetail']['quantity']));?>
									<?php echo $this->Form->input('AcrClientInvoice.quantity.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'quantity-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'label'=>false,'class'=>'form-control inputwidth','type'=>'text','value'=>$detailVal['AcrInvoiceDetail']['quantity']));
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								...
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero ">
									<?php echo $this->Form->input('AcrClientInvoice.unit_rate.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'rate-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'label'=>false,'class'=>'form-control inputwidth','type'=>'text','value'=>$detailVal['AcrInvoiceDetail']['unit_rate']));
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero ">
									<?php echo $this->Form->input('AcrClientInvoice.discount_percent.'.$detailVal['AcrInvoiceDetail']['id'],array('id'=>'discount-'.$detailVal['AcrInvoiceDetail']['id'],'div'=>false,'label'=>false,'class'=>'form-control inputwidth','type'=>'text','onkeyup'=>'this.value = minmax(this.value, 0, 100)', 'value'=>$detailVal['AcrInvoiceDetail']['discount_percent']));
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group filed-left drop-down marginleftrightzero form-dropdown margin-bottom-zero">
								...
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero chossen_width">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero " id = "lineTotal-<?php echo $detailVal['AcrInvoiceDetail']['id']?>">
									<?php echo $this->Form->input('AcrClientInvoice.line_total.'.$detailVal['AcrInvoiceDetail']['id'],array('div'=>false,'label'=>false,'class'=>'form-control inputwidth','type'=>'text','disabled'=>'disabled','value'=>$detailVal['AcrInvoiceDetail']['line_total']));?>
								</div>
	                        </div>
						</div>
					</div>
		   ...
		   <div class="row marginleftrightzero paddingbottom20">
			<div class="clearfix form-actions margintopzero paddingtopzero no-padding-left no-padding-right">
				<div class="col-md-offset-3 col-md-6 footerbutton">
					...
					<?php echo  $this->Form->button(__('<i class="icon-save bigger-110"></i> Save Recurring Invoice'),array('url'=>array('controller'=>'acr_client_recurring_invoices','action'=>'edit',$detailVal['AcrInvoiceDetail']['id']),'div'=>false,'class' => 'btn btn-info saveQuote button_mobile','name'=>'Save Invoice','value'=>'1'));?>
