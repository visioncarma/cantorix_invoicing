...
<div class="page-content">
	...
	<div class="row marginleftrightzero">
			<div class="col-lg-8 paddingleftrightzero">
				...
				<div class="row marginleftrightzero" id = "currencyDiv">
					<div class="form-group  marginleftrightzero">
						...
						<div class="col-xs-12 col-sm-3 col-lg-2 marginleftrightzero paddingleftrightzero countrybilling max-height max-width choosen_width">
							<?php echo $this -> Form -> input('cpn_currency_id', array('id' => 'invoiceCurrencySelect', 'div' => false, 'label' => false, 'options' => array('' => '', $currencyList), 'default' => $defaultCurrency, 'data-live-search' => 'true','data-placeholder'=>"Select Currency",  'class'=>'form-control invdrop','data-placeholder' => "Currency List",'disabled'=>'disabled'));
				...
				<div class="row marginleftrightzero">
					<div class="form-group filed-left marginleftrightzero width100">
						...
						<div class="col-xs-12 col-sm-3 col-lg-3 marginleftrightzero paddingleftrightzero choosen_width" id = "invoiceNumber">
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group marginleftrightzero margin-bottom-zero">
								<?php echo $this -> Form -> input('AcrClientInvoice.description.1', array('div' => false, 'label' => false, 'class' => 'col-xs-10','maxlength'=>'55', 'type' => 'textarea','rows'=>'2', 'placeholder' => 'Inventory description', 'readonly' => 'readonly')); ?>
							</div>
						</div>
					</div>
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
					...
					<div class="col-xs-12 marginleftrightzero nopaddingleft nopaddingright paddingtopbottom5">
						...
						<div class="col-xs-7 font13  mobileClientName"> 
							<div class="form-group filed-left drop-down marginleftrightzero form-dropdown margin-bottom-zero">
								...
								<div class="col-xs-10 marginleftrightzero paddingleftrightzero choosen_width">
									<?php echo $this -> Form -> input('AcrClientInvoice.tax_inventory.1', array('div' => false, 'label' => false, 'class' => 'form-control invdrop','data-placeholder'=>"Select Tax", 'options' => array('' => 'Select Tax', $taxList), 'readonly' => 'readonly')); ?>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="modal-content">
			<div class="modal-header page-header">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?php echo $this->Form->input('addInventory.editDescription-'.$detailVal['AcrInvoiceDetail']['id'],array('div'=>false,'label'=>false,'type'=>'textarea','rows'=>'2','class'=>'form-control col-xs-10 env-desc-'.$rowId.' col-sm-5 itemdescription','id'=>'form-field-2','autocomplete'=>'off','Placeholder'=>'Description of the inventory'));?>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<label>
							<?php echo $this->Form->checkbox('addInventory.editTrack-'.$rowId,array('div'=>false,'label'=>false,'class'=>'ace checkBoxClick'));?>
				...
				$(document).ready(function(){
					...
					$('#addnewunittype-<?php echo $rowId;?>').on('show.bs.modal', function (e) {
				  		...
				  		$('.currentstock').hide();
				  		$('#addInventoryEditTrack-<?php echo $rowId;?>').attr('checked', false); // Unchecks it
					});
					...
					$('.close-submit2').click(function(evt){
				    	 ...
				    	 if ($('#addInventoryEditTrack-<?php echo $rowId;?>').is(':checked')) {
           		...
           		<div class="row marginleftrightzero">
           			<div class="form-group marginleftrightzero">
           				...
           				<div class="col-sm-10 marginleftrightzero paddingleftrightzero">
           					<?php echo $this->Form->input('terms',array('div'=>false,'label'=>false,'class'=>'termsandconditions width100','rows'=>'6','cols'=>'30','type'=>'textarea','value'=>$termsAndConditions))?>
           				</div>
           			</div>
           		</div>
           		<div class="row marginleftrightzero">
           			<div class="form-group marginleftrightzero">
           				...
           				<div class="col-sm-10 marginleftrightzero paddingleftrightzero">
           					<?php echo $this->Form->input('note',array('div'=>false,'label'=>false,'class'=>'termsandconditions width100','rows'=>'6','cols'=>'30','type'=>'textarea','value'=>$defaultNotes))?>
           				</div>
           			</div>
           		</div>
           </div>
		   ...
		   <div class="row marginleftrightzero paddingbottom20">
			<div class="clearfix form-actions margintopzero paddingtopzero no-padding-left no-padding-right">
				<div class="col-md-offset-3 col-md-6 footerbutton">
					...
					<?php echo $this -> Form -> button(__('<i class="icon-save bigger-110"></i> Save Recurring Invoice'), array('url' => array('controller' => 'acr_client_recurring_invoices', 'action' => 'add'), 'div' => false, 'class' => 'btn btn-info saveQuote button_mobile', 'name' => 'Save Invoice', 'value' => '1')); ?>
