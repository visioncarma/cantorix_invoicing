<div class="sbsSubscriberTaxes view">
<h2><?php echo __('Sbs Subscriber Tax'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($sbsSubscriberTax['SbsSubscriberTax']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($sbsSubscriberTax['SbsSubscriberTax']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Code'); ?></dt>
		<dd>
			<?php echo h($sbsSubscriberTax['SbsSubscriberTax']['code']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Percent'); ?></dt>
		<dd>
			<?php echo h($sbsSubscriberTax['SbsSubscriberTax']['percent']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Sbs Subscriber'); ?></dt>
		<dd>
			<?php echo $this->Html->link($sbsSubscriberTax['SbsSubscriber']['name'], array('controller' => 'sbs_subscribers', 'action' => 'view', $sbsSubscriberTax['SbsSubscriber']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Sbs Subscriber Tax'), array('action' => 'edit', $sbsSubscriberTax['SbsSubscriberTax']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Sbs Subscriber Tax'), array('action' => 'delete', $sbsSubscriberTax['SbsSubscriberTax']['id']), null, __('Are you sure you want to delete # %s?', $sbsSubscriberTax['SbsSubscriberTax']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Sbs Subscriber Taxes'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Sbs Subscriber Tax'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($sbsSubscriberTax['AcrInvoiceDetail'])): ?>
	...
	<?php foreach ($sbsSubscriberTax['AcrInvoiceDetail'] as $acrInvoiceDetail): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($sbsSubscriberTax['SbsSubscriberTaxGroupMapping'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<?php foreach ($sbsSubscriberTax['SbsSubscriberTaxGroupMapping'] as $sbsSubscriberTaxGroupMapping): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($sbsSubscriberTax['SlsQuotationProduct'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Quantity'); ?></th>
	...
	<?php foreach ($sbsSubscriberTax['SlsQuotationProduct'] as $slsQuotationProduct): ?>
		<tr>
