...
<div class="page-content">
	...
	<div class="form-horizontal left width-100 paddingbottom20 margintopzero">
		<div class="row marginleftrightzero">
			<div class="col-lg-12 col-sm-12 paddingleftrightzero">
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero marginbottom10">
						<label  class="col-md-3 col-sm-3 control-label marginleftrightzero paddingleftrightzero">Invoice No</label>
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero marginbottom10">
						<label  class="col-sm-3 control-label marginleftrightzero paddingleftrightzero">Invoice Payment Status</label>
						<div class="col-sm-9 marginleftrightzero paddingleftrightzero">
	...
	<table id="sample-table-1" class="table table-striped table-bordered table-hover editable-table marginbottom40">
		<thead>
			<tr>
				...
				<th class="width130 textright">Payment Amount</th>
			</tr>
		</thead>
		<tbody>			
