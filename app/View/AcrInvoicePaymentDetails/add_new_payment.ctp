	...
	<?php echo $this -> Form -> create('addNewPayment', array('id'=>'addNewPayment','class' => 'form-horizontal formdetails', 'role' => 'form')); ?>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingleftrightzero">
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero marginbottom10">
						<label  class="col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label marginleftrightzero paddingleftrightzero">Invoice No</label>
						<div class="form-group filed-left margin-bottom-zero form-filter-field col-lg-3 col-md-5 col-sm-6 col-xs-12 nopadding marginleftrightzero max-height labelerror marginbottom10 choosen_width">							
						<?php echo $this -> Form -> input('invoice_number', array('id' => 'invNumber', 'data-live-search'=>'true', 'div' => false, 'label' => false, 'class' => 'form-control invdrop selectitem','value'=>$invoiceNumber,'data-placeholder'=>"Select", 'options'=>array(''=>'',$invoicesDisplay)));
				...
				<div class="row marginleftrightzero">
					<div class="form-group filed-left drop-down marginleftrightzero form-dropdown relative heightauto marginbottom10">
						<label  class="col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label marginleftrightzero paddingleftrightzero">Payment Method</label>
						<div class="form-group filed-left margin-bottom-zero form-filter-field col-lg-3 col-md-3 col-sm-6 col-xs-12 nopadding marginleftrightzero labelerror marginbottom10 choosen_width">							
							<?php echo $this->Form->input('payment_method',array('div'=>FALSE,'label'=>FALSE,'class'=>'form-control invdrop selectitem','data-placeholder'=>"Select",'options'=>array(''=>'',$paymentMethods)));?>
						</div>
					</div>
				</div>
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						<label  class="col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label marginleftrightzero paddingleftrightzero">Receipt Amount</label>
						<div class="col-sm-3 marginleftrightzero paddingleftrightzero">
							<div class="col-lg-3 col-sm-4 marginleftrightzero paddingleftrightzero col-xs-3">								
								<?php echo $this->Form->input('invoice_currency',array('div'=>FALSE,'label'=>FALSE, 'id'=>'addPaymentInvoiceCurrency', 'value'=>"$invoicedCurrency", 'class'=>'form-control text-center bold', 'readonly'=>"readonly"));?>  
							</div>
							<div class="col-lg-9 col-md-5 col-sm-8 marginleftrightzero paddingleftrightzero col-xs-9">								
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						<label  class="col-lg-4 col-md-4 col-sm-4 col-xs-12 control-label marginleftrightzero paddingleftrightzero">Outstanding Balance</label>
						<div class="col-sm-3 marginleftrightzero paddingleftrightzero">
							<div class="col-lg-3 col-sm-4 marginleftrightzero paddingleftrightzero col-xs-3">								
								<?php echo $this->Form->input('invoice_currency_dsply',array('div'=>FALSE,'label'=>FALSE, 'id'=>'addPaymentInvoiceCurrencyDsply', 'value'=>"$invoicedCurrency", 'class'=>'form-control text-center bold','disabled'=>"disabled"));?>  
							</div>
							<div class="col-lg-9 col-md-5 col-sm-8 marginleftrightzero paddingleftrightzero col-xs-9">								
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						<label  class="col-sm-4 col-xs-12 control-label marginleftrightzero paddingleftrightzero">Payment Date</label>
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 marginleftrightzero paddingleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-sm-6 marginleftrightzero paddingleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						<label  class="col-sm-4 col-sx-12 control-label marginleftrightzero paddingleftrightzero">Notes</label>
						<div class="col-sm-8 col-xs-12 col-md-3 marginleftrightzero paddingleftrightzero">							
				...
				<div class="row marginleftrightzero">
					<div class="form-group filed-left drop-down marginleftrightzero form-dropdown">
						<label  class="col-sm-4 col-xs-7 control-label marginleftrightzero paddingleftrightzero">Payment Received Confirmation</label>
						<div class="col-sm-3 col-xs-5 marginleftrightzero paddingleftrightzero">
							<label>								
		...
		<div class="row marginleftrightzero paddingbottom20">
			<div class="clearfix margintopzero paddingtopzero no-padding-left no-padding-right">
				<div class="col-md-offset-4 footerbutton">
					...
					<?php echo $this->Form->button("<i class='icon-ok bigger-110'></i> Submit", array('div'=>false,'class'=>'btn btn-info onsubmit button_mobile','url' => array('controller'=>'AcrInvoicePaymentDetails','action' => 'addNewPayment'),'escape'=>false));?>
					<?php echo $this->Form->button('<i class="icon-undo bigger-110"></i> Reset', array('div'=>false,'class'=>'btn btn-inverse button_mobile','type'=>'reset','escape'=>false));?>
	...
	<table id="sample-table-1" class="table table-striped table-bordered table-hover editable-table">
		<thead>
			<tr>
				...
				<th class="width150 text-right">Payment Amount</th>
			</tr>
		</thead>
		<tbody>				
			...
			<tr>
				...
				<td class="text-right"><span class="on-load ">
...
<script type="text/javascript">
	...
	// popup
    	...
    	$('.onsubmit').click(function(e){ 
			...
			messages: {
				'data[addNewPayment][invoice_number]': "Please enter the invoice number.",
