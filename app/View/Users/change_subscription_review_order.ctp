<?php
			...
			$L_BILLINGAGREEMENTDESCRIPTION0 = '<span style="color:#000000;">'."$subscription_name : Monthly Recurring Charge (Incl. Tax) = $billAmount $currency_code with effect from $recurrinBillDate. ";
	 	 echo $this -> Form -> create('orderForm',array('url' => array('controller' => 'users', 'action' => 'changeSubscriptionMakePayment',$upgrade),'id'=>'orderForm'));
		 echo $this -> Form -> hidden('subscriber_id',array('value'=>$subscriberId)); 
