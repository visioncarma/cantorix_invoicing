										...
										<fieldset>
											...
											<div class="space-24"></div>
									  		<label class="block">												
												...
												<span class="lbl"> Accept <a href="https://cantorix.com/terms-of-service/"  target="_blank" data-toggle="modal" class="">Terms and Conditions</a> </span> 
												<span class="error-placement"></span>
											</label>

											<label class="block">
												<?php echo $this->Form->checkbox('policy',array('class'=>'ace','div'=>FALSE,'label'=>FALSE));?>
												<span class="lbl"> Accept <a href="https://cantorix.com/privacy-policy/"  target="_blank" data-toggle="modal" class="">Privacy Policy </a> </span> 
												<span class="error-placement"></span>
											</label>
											<div class="space-24"></div>
											<div class="clearfix">
