		...
		<div class="main-container-inner">
			<div class="main-content trialexceeded">
				<div class="page-content">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pricing-span-body pricing-span-bodypaddingneed trialdays no-padding-left no-padding-right">
							<div class="downgrade_subscription upgrade_subscription">
								<div class="position-relative">
									<div class="center ">
										<h2 class="smaller bluetext fs-480"> Your <?php echo $currentPlan['CpnSubscriptionPlan']['validity'];?>-days free trial period has expired.</h2>
									</div>
									<div class="center ">
										<h2 class="smaller bluetext fs-480"> We would like to keep you on as a subscriber,</h2>
									</div>
									<div class="center ">
										<h2 class="smaller bluetext fs-480"> if you wish to continue then please subscribe to one of the pricing options below.</h2>
									</div>
									<div class="center bolder">
										<h2 class="smaller bolder fs-480"> Choose Your Pricing Option </h2>
									</div>
									<?php foreach($plans as $plan):?>
										<?php 
											if($plan['CpnSubscriptionPlan']['type'] == 'Unlimited'){
												$firstClass = "pricing-span3 span100percentblue bluetheme commoncellpaddinggg span50percentblue nomargineft orangee width-margin-480";
												$lastClass = "uppercase textdecor btn btn-primary bolder btn-lg btn-warning";
											} else {
												$firstClass = "pricing-span3 span100percentblue bluetheme commoncellpaddinggg span50percentblue width-margin-480";
										...
										<div class="pricingboxx rightbottomshadow">
											...
											<div class="common_priceboxrow_signup common_priceboxrow_signup_downgrade">
												<div class="pricing_signupp">
													<div class="">
													    <?php $unlimitedPlan = $plan['CpnSubscriptionPlan']['type'].'-'.$plan['CpnSubscriptionPlan']['id'];?>
														<?php echo $this->Html->link('Select',array('action'=>'paymentDetailRenewal',base64_encode($unlimitedPlan)),array('class'=>$lastClass));?>
													</div>
												</div>
											</div>
										</div>
