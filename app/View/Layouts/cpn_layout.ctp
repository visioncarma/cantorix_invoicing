...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>
			<?php $cakeDescription = __d('cake_dev', 'CantoriX'); ?>
		...
		<?php
			...
			echo $this->Html->css(array('bootstrap.min','font-awesome.min','ace-fonts','ace.min','ace-rtl.min','ace-skins.min','template','bootstrap-select','template_dashboard','chosen','customresponsive','datepicker'));
		?>
		<?php
	   		echo $this->Html->script(array('jquery-2.0.3.min.js','jquery-ui-1.10.3.custom.min.js','bootstrap.min.js','typeahead-bs2.min.js','ace-elements.min.js','ace.min.js','jquery.validate.min.js','ace-extra.min.js','chosen.jquery.min.js','bootstrap-select.js','admin_dashboard_js.js','bootstrap-datepicker.min.js','jquery.placeholder.js'));
		?>
		<script type="text/javascript">
			window.jQuery || document.write("<script src=<?php echo $this->webroot."jquery-2.0.3.min.js"?>>"+"<"+"/script>");
		</script>
		...
		<div class="navbar navbar-default headerbg nav_header_border" id="navbar">	
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					...
					?>
					<?php echo $this->Html->link($this->Html->image('logo_cantorix.png',array('alt'=>'logo')),"$homeLink",array('escape'=>FALSE,'class'=>'navbar-brand'));?>
					<!-- /.brand -->
				</div><!-- /.navbar-header -->
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<?php if($profile_pic['User']['profile_picture_path']){?>
									...
									?>
								<img class="nav-user-photo" src="<?php echo $imgLink.$webroot_name.$profile_pic['User']['profile_picture_path'];?>"  alt="profilepic"/>
								<?php }else{
