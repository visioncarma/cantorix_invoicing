...
/*** Table starts here **/ 
	...
	$heading_part ='<table style="border-bottom: 1px solid #2E2E2E;">
                    ...
                    <td style="width:150;float:left;text-align:right;font-family: Arial; font-size: 22.5pt;">
   ...
   $addresspart ='<table>
	...
	$datepart ='<table>
                    ...
                    <td style="border-bottom: 1px solid #d8d8d8;width:100px;float:left;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">'.str_repeat("&nbsp;",3).'PO #
                    </td>
                    <td style="width:23px;float:left;"></td>
                 </tr>
