...
/*** Table starts here **/ 
	...
	$heading_part ='<table style="border-bottom: 1px solid #2E2E2E;">
					...
					<tr style="float:left;background-color:#FFFFFF;">
	                    <td style="width:405px;float:left;color:#4E68A1;font-family:Arial;font-weight:Bold;text-align:left; font-size: 22.5pt;">'.str_repeat("&nbsp;", 1).'INVOICE
                    ...
                    <td style="width:405px;float:left;color:#00000A;font-family:Arial;text-align:left; font-size:9.5pt;">
                   	<table width="150"><tr><td style="font-family: Arial;">Inv #</td><td style="font-family: Arial;font-weight: bold;">'.$invoiceData['AcrClientInvoice']['invoice_number'].'</td></tr><tr><td style="font-family: Arial;">PO #</td><td style="font-family: Arial;font-weight: bold;">'.$invoiceData['AcrClientInvoice']['purchase_order_no'].'</td></tr><tr><td style="font-family: Arial;">Invoice Date</td><td style="font-family: Arial;font-weight: bold;">'.date($dateFormat,strtotime($invoiceData['AcrClientInvoice']['invoiced_date'])).'</td></tr><tr><td style="font-family: Arial;">Due Date</td><td style="font-family: Arial;font-weight: bold;">'.date($dateFormat,strtotime($invoiceData['AcrClientInvoice']['due_date'])).'</td></tr></table></td>
   ...
   $addresspart ='<table>
				...
				<td style="width:120px;float:left;text-align:left;font-family: Arial;  font-size: 10pt;font-weight: bold;"></td>
				...
				<td style="width:120px;float:left;text-align:right; background-color:#4E68A1; border-bottom: 1px solid #4E68A1; font-family: Arial;  font-size: 10pt;font-weight: bold;"></td>
                ...
                <td style="width:120px;float:left;text-align:right; background-color:#4E68A1;color:#ffffff;  border-bottom: 1px solid #4E68A1; left;font-family: Arial;  font-size: 13.5pt; font-weight: bold;">'.$subscriberOrganisationDetail['SbsSubscriberOrganizationDetail']['organization_name'].'</td>
                <td style="width:10px;float:left;text-align:right; background-color:#4E68A1;  border-left: 1px solid #4E68A1; border-right: 1px solid #4E68A1; border-bottom: 1px solid #4E68A1; font-family: Arial; font-size: 10pt;"></td>
                <td style="width:23px;float:left;"></td>
                </tr>
                <tr style="float:left;background-color:#FFFFFF;">
                ...
                <td style="width:120px;float:left;text-align:right; background-color:#4E68A1;color:#ffffff;  border-bottom: 1px solid #4E68A1; font-family: Arial; font-size: 10pt; ">'.$subscriberAddress.'</td>
                ...
                <td style="width:120px;float:left;text-align:right; background-color:#4E68A1; border-bottom: 1px solid #4E68A1; font-family: Arial; font-size: 10pt;"></td>
                <td style="width:10px;float:left;text-align:right; background-color:#4E68A1;border-left: 1px solid #4E68A1; border-right: 1px solid #4E68A1; border-bottom: 1px solid #4E68A1; font-family: Arial; font-size: 10pt;"></td>
                <td style="width:23px;float:left;"></td>
                </tr>
                <tr style="float:left;background-color:#FFFFFF;">
                <td style="width:5px;float:left;color:#0f6082;"></td>
                <td style="width:400px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                <td style="width:120px;float:left;text-align:right;font-family: Arial; font-size: 10pt;"></td>
	...
	$items.='<tr style="float:left;background-color:#FFFFFF;">
                    ...
                    <td style="border-bottom: 1px solid #888888;width:88px; color: #4E68A1; font-family:Arial;text-align:left; font-size: 8pt;">'.$v['InvInventory']['name'].'&nbsp;</td>
                    <td style="border-bottom: 1px solid #888888;width:205px;font-family:Arial;text-align:left; font-size: 8pt;">'.$v['AcrInvoiceDetail']['inventory_description'].'&nbsp;
                    </td>
                    ...
                    <td style="border-bottom: 1px solid #888888;width:75px;font-family:Arial;text-align:right; font-size: 8pt;">
                   		'.$this->Number->currency($v['AcrInvoiceDetail']['unit_rate']/$invoiceData['AcrClientInvoice']['exchange_rate'],'',$options).'
                    </td>
                    <td style="border-bottom: 1px solid #888888;width:45px;font-family:Arial;text-align:right; font-size: 8pt;">
                   		'.$discount.'
                    </td>
                    <td style="border-bottom: 1px solid #888888;width:75px;font-family:Arial;text-align:right; font-size: 8pt;">'.$this->Number->currency($v['AcrInvoiceDetail']['line_total']/$invoiceData['AcrClientInvoice']['exchange_rate'],'').'</td>
                 	<td style="width:12px;border-bottom: 1px solid #888888;float:left;"></td>
                 </tr>';
	}
	...
	$payements.='<tr>
		...
		/*$payements.='
				<tr style="float:left;">
                    ...
                    <td style="width:88px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                    <td style="width:175px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">
                    ...
                    <td style="width:75px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                    <td style="width:12px;flaot:left;"></td>
                 </tr>
	...
	<tr>
     ...
     /* $payements.='
                 ...
                 <tr style="float:left;">
                    ...
                    <td style="border-bottom: 1px solid #d8d8d8;width:88px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                    ...
                    <td style="border-bottom: 1px solid #d8d8d8;width:75px;float:left;font-family:Arial;text-align:right; font-size: 10pt;"></td>
                 	<td style="width:12px;flaot:left;border-bottom:1px solid #d8d8d8"></td>
                 </tr>
                 '; */
...
$html = <<<EOD
	...
	<table  cellpadding="0">
	  ...
	  <tr>
	    ...
	    <th style="width:88px;border-bottom: 1px solid #888888;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">Service</th>
	    ...
	    <th style="width:75px;border-bottom: 1px solid #888888;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;">Amount</th>
	  	<th style="width:12px;border-bottom: 1px solid #888888;float:left;"></th>
	  </tr>
	  $items
	  </table>
