...
/*** Table starts here **/ 
	...
	if($logo){
		...
		$for_image = APP.'webroot/files/uploads/logo-subscriber'.$invoiceData['AcrClientInvoice']['sbs_subscriber_id'].'/'.$explodedValue;
	}else{
		$for_image = APP."webroot/img/logo.png";
	}
	$heading_part ='<table>
...
$html = <<<EOD
	...
	<table  cellpadding="0">
	  ...
	  <tr>
	    ...
	    <th style="width:100px;border-bottom: 1px solid #888888;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">Item</th>
...
$tmp = APP."webroot/files/uploads/invoice/Subscriber-".$subscriberId;
