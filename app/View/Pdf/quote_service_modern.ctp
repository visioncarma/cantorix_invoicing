...
/*** Table starts here **/ 
	...
	$heading_part ='<table style="border-bottom: 1px solid #2E2E2E;">
                    	...
                    	'.nl2br("\n\t").'<span style="font-family: Arial;">'.str_repeat("&nbsp;", 2).'Expiry Date'.str_repeat("&nbsp;", 4).'</span><span style="font-family: Arial;font-weight: bold;">'.$expiryDate.'</span>
                    </td>
   ...
   <td style="width:23px;float:left;"></td>
	...
	$items.='<tr style="float:left;background-color:#FFFFFF;">
                    ...
                    <td style="border-bottom: 1px solid #d8d8d8;width:87px; color: #4E68A1;font-family:Arial;text-align:left; font-size: 8pt;">'.$v['InvInventory']['name'].'</td>
                    ...
                    <td style="border-bottom: 1px solid #d8d8d8;width:75px;font-family:Arial;text-align:right; font-size: 8pt;">'.$this->Number->currency(($v['SlsQuotationProduct']['line_total']/$quote['SlsQuotation']['exchange_rate']),'').'</td>
                 	<td style="width:13px;float:left;border-bottom: 1px solid #d8d8d8;"></td>
                 </tr>';
	}
	$items.='<!--<tr style="float:left;background-color:#FFFFFF;">
					<td style="width:10px;float:left;color:#0f6082;"></td>
	...
	/*$payements.='
				<tr style="float:left;">
                    ...
                    <td style="width:87px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                    <td style="width:175px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">
                    ...
                    <td style="width:75px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                 	<td style="width:13px;float:left;"></td>
                 </tr>
	...
	/*$payements.='<tr style="float:left;">
      ...
      /*$payements.='
                ...
                <tr style="float:left;">
                    ...
                    <td style="border-bottom: 1px solid #d8d8d8;width:87px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                    ...
                    <td style="border-bottom: 1px solid #d8d8d8;width:75px;float:left;font-family:Arial;text-align:right; font-size: 10pt;"></td>
                 	<td style="width:13px;border-bottom: 1px solid #d8d8d8;float:left;"></td>
                 </tr>
                 '; */
	...
	$popularised ='<table>
                ...
                <tr style="float:left;background-color:#FFFFFF;">
				<td style="width:10px;float:left;color:#0f6082;"></td>
                    <td style="width:420px;float:left;font-family:Arial;text-align:left; font-weight:Bold;  font-size: 10pt;"> Customer Notes</td>
                    
                 </tr>
                <tr style="float:left;background-color:#FFFFFF;">
				<td style="width:10px;float:left;color:#0f6082;"></td>
                    <td style="width:420px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">'
                    	.$quote['SlsQuotation']['notes']. 
                    '</td></tr></table>'; 
...
$html = <<<EOD
	...
	<table  cellpadding="0">
	  ...
	  <tr>
	    ...
	    <th style="width:85px;border-bottom: 1px solid #d8d8d8;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">Service</th>
	    ...
	    <th style="width:75px;border-bottom: 1px solid #d8d8d8;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;">Rate</th>
	  ...
	  <table  style="background-color: #f5f5f5;" cellpadding="">
	  $payements
	  </table>
