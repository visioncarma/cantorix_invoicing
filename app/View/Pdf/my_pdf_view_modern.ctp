...
/*** Table starts here **/ 
   ...
   $heading_part ='<table style="border-bottom: 1px solid #2E2E2E;"><tr style="float:left;background-color:#FFFFFF;"><td style="width:405px;float:left;color:#4E68A1;font-family:Arial;font-weight:Bold;text-align:left; font-size: 22.5pt;">INVOICE</td><td rowspan = "2" style="width:125;float:right;text-align:right;font-family: Arial; font-size: 30px; font-weight: bold;"><img src="'.$for_image.'" alt="test alt attribute" border="0" /></td>'.'</tr><tr style="float:left;background-color:#FFFFFF;"><td style="width:405px;float:left;color:#00000A;font-family:Arial;text-align:left;"><table width="200"><tr><td style="font-family: Arial;">Inv #</td><td style="font-family: Arial;font-weight: bold;">'.$invoiceData['AcrClientInvoice']['invoice_number'].'</td></tr><tr><td style="font-family: Arial;">PO #</td><td style="font-family: Arial;font-weight: bold;">'.$invoiceData['AcrClientInvoice']['purchase_order_no'].'</td></tr><tr><td style="font-family: Arial;">Invoice Date</td><td style="font-family: Arial;font-weight: bold;">'.date($dateFormat,strtotime($invoiceData['AcrClientInvoice']['invoiced_date'])).'</td></tr><tr><td style="font-family: Arial;">Due Date</td><td style="font-family: Arial;font-weight: bold;">'.date($dateFormat,strtotime($invoiceData['AcrClientInvoice']['due_date'])).'</td></tr></table></td></tr></table>'; 
   ...
   <td style="width:23px;float:left;"></td>
	...
	$items.='<tr style="float:left;background-color:#FFFFFF;">
			...
			<td style="border-bottom: 1px solid #888888;width:85px;color: #4E68A1;font-family:Arial;text-align:left;font-size: 8pt;">'.$v['InvInventory']['name'].'</td>
			<td style="border-bottom: 1px solid #888888;width:205px;font-family:Arial;text-align:left; font-size: 8pt;">'.$v['AcrInvoiceDetail']['inventory_description'].'</td>
			<td style="border-bottom: 1px solid #888888;width:30px;font-family:Arial;text-align:right; font-size: 8pt;">'.$v['AcrInvoiceDetail']['quantity'].'</td>
			<td style="border-bottom: 1px solid #888888;width:75px;font-family:Arial;text-align:right; font-size: 8pt;">'.$this->Number->currency($v['AcrInvoiceDetail']['unit_rate']/$invoiceData['AcrClientInvoice']['exchange_rate'],'').'</td>
			<td style="border-bottom: 1px solid #888888;width:45px;font-family:Arial;text-align:right; font-size: 8pt;">'.$discount.'</td>
			...
			<td style="width:15px;border-bottom: 1px solid #888888;float:left;"></td>
		</tr>';}
	...
	$payements=null;
	// Use for Payements SubTotal
		$payements.='<tr>
            <td width="10" style="background-color:#FFFFFF"></td>
            
            <td width="100%">
				<table>
				<tr><td align="right" width="77%" style="font-family:Arial;font-size:8pt;font-weight:Bold;">SubTotal</td>
				<td align="right" width="23%" style="font-family:Arial;font-size:8pt;">'.$this->Number->currency($invoiceData['AcrClientInvoice']['sub_total']/$invoiceData['AcrClientInvoice']['exchange_rate'],$subscriberCurrencyCode).' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
				</table>
            </td>
		</tr>';
     // Use for Payements SubTotal
...
$payements.='
	...
	$popularised ='<table>
                ...
                <tr style="float:left;background-color:#FFFFFF;">
					<td style="width:10px;float:left;color:#0f6082;"></td>
                    <td style="width:420px;float:left;font-family:Arial;text-align:left; font-weight:Bold;  font-size: 10pt;">Customer Note
                    </td>
...
$html = <<<EOD
	...
	<table  cellpadding="0">
	    ...
	    <th style="width:85px;border-bottom: 1px solid #ffffff;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;"></th>
	    <th style="width:205px;border-bottom: 1px solid #ffffff;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;"></th>
	    <th style="width:30px;border-bottom: 1px solid #ffffff;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;"></th>
	    <th style="width:75px;border-bottom: 1px solid #ffffff;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;"></th>
	    <th style="width:45px;border-bottom: 1px solid #ffffff;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;"></th>
	    <th style="width:75px;border-bottom: 1px solid #ffffff;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;"></th>
	    <th style="width:15px;border-bottom: 1px solid #ffffff;float:left;"></th>
	  </tr>
	  <tr>
	    <th style="width:10px;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;"></th>
	    <th style="width:85px;border-bottom: 1px solid #888888;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">Item</th>
	    <th style="width:205px;border-bottom: 1px solid #888888;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">Description</th>
	    ...
	    <th style="width:75px;border-bottom: 1px solid #888888;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;">Unit Price</th>
	    <th style="width:45px;border-bottom: 1px solid #888888;font-family:Arial;font-weight:Bold;text-align:right; font-size: 10pt;">Disc %</th>
	    ...
	    <th style="width:15px;border-bottom: 1px solid #888888;float:left;"></th>
	  </tr>
	  $items
	  </table>
