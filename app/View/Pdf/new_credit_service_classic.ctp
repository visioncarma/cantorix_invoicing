...
/*** Table starts here **/ 
    ...
    $heading_part ='<table>
                    ...
                    <td style="border-bottom: 1px solid #888888;width:190;float:left;text-align:right;font-family: Arial; font-size: 22.5pt;">
   ...
   $addresspart ='<table>
    ...
    $datepart ='<table>
                    ...
                    <tr style="float:left;background-color:#FFFFFF;">
                    <td style="width:150px;float:left;color:#0f6082;"></td>
                    <td style="border-bottom: 1px solid #d8d8d8;width:100px;float:left;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">
                        Issue Date
                    </td>
                    <td style="border-bottom: 1px solid #d8d8d8;width:100px;font-family:Arial;font-weight:Bold;text-align:center; font-size: 10pt;">'.str_repeat("&nbsp;",3).'Reference #
                    </td>
                    <td style="width:23px;float:left;"></td>
                 </tr>
                 ...
                 <tr style="float:left;background-color:#FFFFFF;">
                    <td style="width:150px;float:left;color:#0f6082;"></td>
                    <td style="width:100px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">
                        '.date($settings['SbsSubscriberSetting']['date_format'],strtotime($credit['AcrClientCreditnote']['date_created'])).'
                    </td>
                    <td style="width:100px;font-family:Arial;text-align:center; font-size: 10pt;">
                        '.$credit['AcrClientCreditnote']['reference_no'].'
                    </td>
                    <td style="width:23px;float:left;"></td>
                 </tr>
                 <tr style="float:left;background-color:#FFFFFF;">
    ...
    $items.='<tr style="float:left;background-color:#FFFFFF;">
                <td style="width:10px;float:left;color:#0f6082;"></td>
                    <td style="border-bottom: 1px solid #d8d8d8;width:100px;font-family:Arial;text-align:left; font-size: 8pt;color: #4E68A1;">'.$v['InvInventory']['name'].'</td>
...
$html = <<<EOD
    ...
    <table  cellpadding="0">
      ...
      <tr>
        ...
        <th style="width:100px;border-bottom: 1px solid #d8d8d8;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">Service</th>
