...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li>
			<?php echo $this->Html->link('Configure Email',array('action'=>'index'),array('escape'=>FALSE))?>
		</li>
		<li class="active">
			Edit Template
		</li>
			...
			<?php echo $this->Form->create('report-writer',array('id'=>'report-writer','class'=>'form-horizontal edit_email_template','role'=>'form'));?>
				...
				<div class="form-group email_body_wrap">
					...
					<div class="col-md-6 col-sm-7 col-sx-12">
						<?php
									echo $this->Form->input('email_subject',array('id'=>'email_subject','label'=>false,'div'=>false,'type'=>'textarea','rows'=>'4','cols'=>'50','value'=>$subject)) ;
						?>
					</div>

					<div class="col-md-2 col-sm-2 col-sx-12 input_cret_item">
						<input type="text" class="btn-warning inserValue" id="email_body_item_field2"  value="Insert value">
							...
							<div class="col-md-6 col-xs-6" id="p">
								...
								<div class="tags_select4">
									<ul>
										...
										<li>
											<a href="javascript:void(0);"><?php echo $rightVal;?></a>
										</li>
										<?php endforeach;?>
									</ul>
								</div>
				...
				<div class="form-group email_body_wrap">
					...
					<div class="col-md-2 col-sm-2 col-sx-12 pull-right input_cret_item">
						<input type="text" class="inserValue btn-warning" id="email_body_item_field" value="Insert value">
						<b class="caret input_cret"></b>
					...
					<div class="col-xs-12 mt-20">
						<?php  
							if($myelement){
									...
									$myelement = str_replace('</pre>', '', $myelement);
									echo $this->Form->textarea('myelement', array('id'=>'email_body','rows'=>'10','cols'=>'130','value'=>$myelement));
							}else{
									echo $this->Form->textarea('myelement', array('id'=>'email_body','rows'=>'10','cols'=>'130'));
							}
						?>			
					</div>
				...
				<div class="clearfix form-actions margintopzero paddingtopzero paddingleftrightzero">
					
					<div class="col-xs-12  col-sm-3 pull-right footerbutton">
						<?php echo  $this->Form->button(__('<i class="icon-ok bigger-110"></i>Save Template'),array('url'=>array('controller'=>'report_writer_templates','action'=>'add',$status,$page),'div'=>false,'class'=>'btn btn-info button_mobile','escape'=>false));?>
