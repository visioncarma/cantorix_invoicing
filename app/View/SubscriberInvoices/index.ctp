		...
		<div class="col-xs-12">
			<div class="table-responsive table-responsivenoscroll overflowvisible">
				...
				<div class="row margin-twenty-zero filterdivmob">
					...
					<div class="form-group filed-left margin-bottom-zero  form-filter-field col-xs-12 col-lg-2 col-md-4 col-sm-4 nopaddingmobile nopaddingleft nopaddingright choosen_width admin_choosen">
						<?php echo $this->Form->input('filterOption',array('label'=>false,'class'=>'form-control invdrop','div'=>false,'data-placeholder'=>"Select Filter Option",'options'=>array(''=>'','Company Name'=>'Company Name','Invoice Number'=>'Invoice Number','Subscriber Name'=>'Subscriber Name')));?>
					</div>
					...
					<div class="form-group filed-left margin-bottom-zero col-xs-12 col-lg-2 col-md-4 col-sm-4 nopaddingmobile nopaddingleft nopaddingright form-filter-field choosen_width admin_choosen">
						<?php echo $this->Form->input('status',array('label'=>false,'class'=>'form-control invdrop','div'=>false,'data-placeholder'=>"Select Status",'options'=>array(''=>'','Completed'=>'Paid','Failed'=>'Due','Pending'=>'Awaiting Payment','Refunded'=>'Void')));?>
					</div>
					<div class="form-group filed-left margin-bottom-zero clearlefttrespon mobile_100">
						<?php echo $this->Form->button('Filter',array('class'=>'btn btn-sm btn-primary filter-btn form-control mobile_100','type'=>'submit'))?>
					</div>
					<div class="form-group filed-left margin-bottom-zero mobile_100">
						<?php echo $this->Js->link('Reset',array('controller'=>'SubscriberInvoices','action'=>'index'),array('class'=>'btn btn-sm btn-primary filter-btn filter_btn_new mobile_100','update'=>'#content'));?>
					</div>
				...
				<table id="sample-table-1" class="table table-striped table-bordered table-hover editable-table">
					<thead>
						<tr>
							...
							<th  class="hidden-480 hidden-column"><?php echo $this->Paginator->sort('invoice_no','Invoice Number',array('update'=>'#content','data'=>array('filterOption'=>$filterOption,'filterBy'=>$filterBy,'status'=>$status)));?></th>
							<th class="hidden-480 hidden-column"><?php echo $this->Paginator->sort('SbsSubscriberOrganizationDetail.organization_name','Company Name',array('update'=>'#content','data'=>array('filterOption'=>$filterOption,'filterBy'=>$filterBy,'status'=>$status)))?></th>
							...
							<th class="hidden-480 invoiceright width200 textright"><?php echo $this->Paginator->sort('last_payment_amount','Invoice Value',array('update'=>'#content','data'=>array('filterOption'=>$filterOption,'filterBy'=>$filterBy,'status'=>$status)));?></th>
					...
					<tbody>
						...
						<?php foreach($cpnSubscriberInvoiceDetails as $cpnSubscriberInvoiceDetail):?>
							<?php if($cpnSubscriberInvoiceDetail['CpnSubscriberInvoiceDetail']['txn_type'] == "recurring_payment"){ ?>
								<tr style ="background-color: #4C72B3;"> 
							<?php }elseif($cpnSubscriberInvoiceDetail['SbsSubscriber']['subscribed_date']>= date('Y-m-01') && ($cpnSubscriberInvoiceDetail['SbsSubscriber']['subscribed_date'] <= date('Y-m-d'))){?>
								<tr style ="background-color: #8C72B3;;">
							<?php }else{ ?>
								<tr> 
							<?php } ?>
							...
							<td class="hidden-480 hidden-column"><span class="on-load"><?php echo $cpnSubscriberInvoiceDetail['SbsSubscriberOrganizationDetail']['organization_name']?><?php /*echo $organization[$cpnSubscriberInvoiceDetail['CpnSubscriberInvoiceDetail']['invoice_no']]*/?></span>
							...
							<td class="hidden-480 invoicevalue">
								<span class="on-load">
