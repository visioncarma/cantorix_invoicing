                   ...
                   <table style="width:100%; height:100%;">
                       <tr>                        
                          ...
                          <table style="width:51%; height:100%;" align="left">
                             <tr >
                                <td colspan="2" style="font-size:22px;bold;font-family:Arial;color:#4E68A1;padding-bottom: 5px;">CREDIT NOTE</td>                           
                            </tr> 
                            <tr>
                                <td style="width:90px;font-family:Arial;font-size: 14px;">
                                	Credit #
                                    <!--<span style="float:left;width:90px;font-family:Arial;font-size: 14px;">Credit #</span>
                                ...
                                <td style="font-weight:bold;font-family:Arial;font-size:14px;">
                                	<?php echo $data['AcrClientInvoice']['credit_no'];?>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-family:Arial;font-size: 14px;">
                                	Reference #
                                    <!--<span style="float:left;width:90px;font-family:Arial;font-size: 14px;">Reference #</span>
                                    <span style="font-weight:bold;font-family:Arial;font-size:14px;"><?php if($data['AcrClientInvoice']['reference_no']){ echo $data['AcrClientInvoice']['reference_no'];}else { echo '--'; }?></span>
                               		-->
                                </td>
                                <td style="font-weight:bold;font-family:Arial;font-size:14px;">
                                	<?php if($data['AcrClientInvoice']['reference_no']){ echo $data['AcrClientInvoice']['reference_no'];}else { echo ''; }?>
                                </td>
                            </tr> 
                            <tr>
                                <td style="font-family:Arial;font-size: 14px;">
                                   ...
                                   <!-- <span style="float:left;width:90px;font-family:Arial;font-size: 14px;">Issue Date</span>
                                    <span style="font-weight:bold;font-family:Arial;font-size:14px;"><?php echo $data['AcrClientInvoice']['issueDate'];?></span>-->
                                </td>
                                <td style="font-weight:bold;font-family:Arial;font-size:14px;">
                   ...
                   <table style="width:100%; height:100%;">
                       <tr>
                           ...
                           <td align="right" style="width:50%;border:0;padding: 10px 40px; vertical-align: top;">
                            <table style="width:60%; background:#4e68a1;color:#fff;padding: 0 27px 0px 15px;text-align:right;" align="right">
                             <tr>
                ...
                <tr>  
                  <td>
                   <table style="width:90%; height:100%;padding-top:10px; background:#F5F5F5;border-bottom:1px solid #d8d8d8" align="center">
                        <tr>
                        <td>
                        <table  style="width:32%; height:100%;padding-top:0px; background:#F5F5F5;" align="right">
                        ...
                        <tr>
                             <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;">Subtotal</td>
                              <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:12px;padding-bottom: 10px;padding-top:10px;"><?php echo $this->Number->currency(($data['AcrClientInvoice']['subTotal']/$data['AcrClientInvoice']['conversionValue']),$data['AcrClientInvoice']['invoice_currency_code']);?></td>  
                        </tr>
                        ...
                        <tr>
                             <td style="width:50%;font-size:13px;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;"><?php echo $taxes[$taxID].'(@'.$taxesByPercent[$taxID].'%)';?></td>
                              <td style="width:50%;font-size:13px;font-family:Arial;text-align:right;padding-right:12px;padding-bottom: 10px;"><?php echo $this->Number->currency(($taxAmount/$data['AcrClientInvoice']['conversionValue']),$data['AcrClientInvoice']['invoice_currency_code']);?></td>  
                        </tr>
                        <?php endforeach;?>
                        <tr>
                             <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;">Total</td>
                              <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:12px;padding-bottom: 10px;padding-top:10px;"><?php echo $this->Number->currency($data['AcrClientInvoice']['invoicetotal'],$data['AcrClientInvoice']['invoice_currency_code']);?></td>  
                        </tr>
