					...
					<tr>
						...
						<table style="width:100%; height:100%;">
							<tr>
								...
								<table style="width:100%;text-align:right;padding-right:22px; height:100%;" align="right">
									<tr>
										<td style="font-size:30px;font-weight:bold;font-family:Arial;margin-bottom:10px;">INVOICE</td>
									</tr>
									<tr>
										<td><span style="margin-right:20px;font-family:Arial;font-size: 14px;">Inv #</span><span style="font-weight:bold;font-family:Arial;font-size: 13px;"><?php echo $invoiceData['AcrClientInvoice']['invoice_number']; ?></span></td>
									</tr>
								</table></td>
							</tr>
						</table></td>
						...
						<table style="width:100%; height:100%;">
							<tr>
								...
								<table style="width:100%;" align="left">
									...
									<tr>
										<td style="font-size:18px;font-weight:bold;font-family:Arial;"><?php
										if ($organisationDetails['SbsSubscriberOrganizationDetail']['organization_name']) { echo $organisationDetails['SbsSubscriberOrganizationDetail']['organization_name'];
										} 
									?></td>
									</tr>
									<?php } ?>
									...
									<tr>
										<td style="font-size:14px;font-family:Arial;"><?php
										if ($organisationDetails['SbsSubscriberOrganizationDetail']['billing_address_line1']) {echo $organisationDetails['SbsSubscriberOrganizationDetail']['billing_address_line1'];
										} 
									?></td>
									</tr>
									<?php } ?>
									...
									<tr>
										<td style="font-size:14px;font-family:Arial;"><?php
										if ($organisationDetails['SbsSubscriberOrganizationDetail']['billing_address_line2']) {echo $organisationDetails['SbsSubscriberOrganizationDetail']['billing_address_line2'];
										}
									?></td>
									</tr>
									<?php } ?>
									...
									<tr>
										<td style="font-size:14px;font-family:Arial;"><?php
										if ($organisationDetails['SbsSubscriberOrganizationDetail']['billing_city']) {echo $organisationDetails['SbsSubscriberOrganizationDetail']['billing_city'];
										}
									?></td>
									</tr>
									<?php } ?>
									...
									<tr>
										<td style="font-size:14px;font-family:Arial;"><?php
										if ($organisationDetails['SbsSubscriberOrganizationDetail']['billing_state']) {echo $organisationDetails['SbsSubscriberOrganizationDetail']['billing_state'];
										} 
									?></td>
									</tr>
									<?php } ?>
									...
									<tr>
										<td style="font-size:14px;font-family:Arial;"><?php
										if ($organisationDetails['SbsSubscriberOrganizationDetail']['billing_country']) {echo $organisationDetails['SbsSubscriberOrganizationDetail']['billing_country'];
										} 
									?></td>
									</tr>
									<?php } ?>
									...
									<tr>
										<td style="font-size:14px;font-family:Arial;"><?php
										if ($organisationDetails['SbsSubscriberOrganizationDetail']['billing_zip']) {echo $organisationDetails['SbsSubscriberOrganizationDetail']['billing_zip'];
										}
									?></td>
									</tr>
									<?php } ?>
					...
					<tr>
						...
						<table style="width:70%; height:100%; cellpadding:0; cellspacing:0;" align="center">
							<tr>
								...
								<td style="width:25%;font-size:13px;font-family:Arial;text-align:right;padding-right:26px;padding-top: 5px;"><?php echo $invoiceData['AcrClientInvoice']['purchase_order_no']; ?></td>
							</tr>
						</table></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<table style="width:90%; height:100%;" align="center">
							<tr>
								...
								<td style="width:16%;font-size:15px;font-family:Arial;font-weight:bold;border-bottom:1px solid #d8d8d8;text-align:right;padding-right:12px;padding-bottom: 10px;padding-top:10px;">Amount</td>
							</tr>
						</table></td>
					</tr>
					...
					<tr>
						...
						<table style="width:90%; height:100%; cellpadding:0; cellspacing:0;" align="center">
							<tr>
								...
								<td style="width:16%;font-size:13px;font-family:Arial;border-bottom:1px solid #d8d8d8;text-align:right;padding-right:12px;padding-bottom: 10px;padding-top:10px;"><?php echo $this -> Number -> currency($v['AcrInvoiceDetail']['line_total'] / $invoiceData['AcrClientInvoice']['exchange_rate'], ''); ?></td>
							</tr>
						</table></td>
					</tr>
					<?php } ?>
					<tr>
						...
						<table style="width:34%; height:100%;" align="right">
							...
							<tr>
								...
								<td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo $this -> Number -> currency($invoiceData['AcrClientInvoice']['invoice_total'], $invoiceData['AcrClientInvoice']['invoice_currency_code'], $options); ?></td>
							</tr>
							<tr>
