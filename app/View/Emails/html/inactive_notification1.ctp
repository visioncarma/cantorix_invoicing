		...
		<table cellspacing="0" style="width:600px;padding:0px; background:#fff; height:100%; border:1px solid #d8d8d8; margin:auto; align:center; cellpadding:0; cellspacing:0; bgcolor:#ffffff;">
			...
			<tr>
				...
				<p style="padding:20px 10px;background:#86B559;">
					...
					<span style="font-size:20px;font-family:arial;color:#fff;font-weight:bold;">Please upgrade your account.</span>
				</p></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="padding:0px 30px;font-size:14px;font-family:arial;color:#666666;font-weight:normal;"> Your “free” subscription to the CantoriX Invoicing application will <u>expire</u> in <u>5 days.</u> We would love to keep you as a customer, in which case, kindly upgrade your account to continue the service. To do this, please click the link below to upgrade your plan.</td>
			</tr>
			<tr>
				<td  style="padding: 7px 0; padding-left:10px;font-size:13px;font-family:arial;color:#ffffff;"></td>
			</tr>
			<tr>
				...
				<p style="padding:10px;background:#2C83B8;width:200px;">
					<a style="font-size:16px;font-family:arial;color:#fff;font-weight:bold;text-decoration:none;" href="<?php echo $resetLink;?>">Upgrade</a>
				</p></td>
			</tr>
			<tr>
			...
			<tr>
				<td  style="padding:0px 30px;font-size:14px;font-family:arial;color:#666666;font-weight:normal;">
					After login upgrade plan in Settings -> Change Subscription -> upgrade Subscription
				</td>
			</tr>
			<tr>
				<td  style="padding: 7px 0; padding-left:10px;font-size:13px;font-family:arial;color:#ffffff;"></td>
			...
			<tr>
				<td style="padding:0px 30px;font-size:14px;font-family:arial;color:#666666;font-weight:normal;"> Thank you for choosing <b>CantoriX Invoicing,</b></td>
			</tr>
			<tr>
				<td  style="padding: 7px 0; padding-left:10px;font-size:13px;font-family:arial;color:#ffffff;"></td>
			</tr>
