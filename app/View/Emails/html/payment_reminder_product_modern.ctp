                   ...
                   <table style="width:100%; height:100%;">
                       <tr>                        
                          ...
                          <table style="width:50%; height:100%;" align="left">
                             <tr>
                                <td style="font-size:30px;float:left;width:130px;font-weight:bold;font-family:Arial;color:#4E68A1;padding-bottom:5px;padding-left:0px;"><?php echo __('INVOICE');?></td>                           
                            </tr> 
                            <tr>
                            ...
                            <tr>
                                <td style="float:left;width:85px;font-family:Arial;font-size: 14px;">
                                    ...
                                    <!--<span style="float:left;width:100px;font-family:Arial;font-size: 14px;"><?php echo __('Invoice Date');?></span>
                ...
                <tr>
                  <td>
                   <table style="width:90%; height:100%;" align="center">
                        <tr>
                           <td style="width:16%;font-size:15px;font-family:Arial;font-weight:bold;border-bottom:1px solid #d8d8d8;text-align:left;padding-left:15px;padding-bottom: 10px;padding-top:10px;"><?php echo __('Item');?></td>
                           ...
                           <td style="width:16%;font-size:15px;font-family:Arial;font-weight:bold;border-bottom:1px solid #d8d8d8;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo __('Qty');?></td>
                            <td style="width:16%;font-size:15px;font-family:Arial;font-weight:bold;border-bottom:1px solid #d8d8d8;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo __('Unit Price');?></td>
                        ...
                        <?php foreach($taxArray as $taxKey=>$taxVal){?>
	                        <tr>
	                             <td style="width:50%;font-size:13px;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;"><?php echo $taxVal['taxName'];?></td>
	                              <td style="width:50%;font-size:13px;font-family:Arial;text-align:right;padding-right:12px;padding-bottom: 10px;"><?php echo $this->Number->currency($taxVal['taxAmount']/$invoiceData['AcrClientInvoice']['exchange_rate'],$invoiceData['AcrClientInvoice']['invoice_currency_code']);?></td>  
	                        </tr>
                        <?php } ?>
                        <!--tr>
                             <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo __('Subscriber Total');?></td>
                              <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo $this->Number->currency($invoiceData['AcrClientInvoice']['func_currency_total'],$subscriberCurrencyCode); ?></td>  
                        </tr-->
                        <tr>
                             <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo __('Invoice Total');?></td>
                              <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:12px;padding-bottom: 10px;padding-top:10px;"><?php echo $this->Number->currency($invoiceData['AcrClientInvoice']['invoice_total'],$invoiceData['AcrClientInvoice']['invoice_currency_code']); ?></td>  
                        </tr>
                        <tr>
                             <td style="width:50%;font-size:13px;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;"><?php echo __('Payments');?></td>
                              <td style="width:50%;font-size:13px;font-family:Arial;text-align:right;padding-right:12px;padding-bottom: 10px;"><?php echo $this->Number->currency($paidAmount,$invoiceData['AcrClientInvoice']['invoice_currency_code']); ?></td>  
                        </tr>
                        <tr>
                             <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo __('Balanace Due');?></td>
                              <td style="width:50%;font-size:14px;font-weight:bold;font-family:Arial;text-align:right;padding-right:12px;padding-bottom: 10px;padding-top:10px;color:red;"><?php echo $this->Number->currency($balanceDue,$invoiceData['AcrClientInvoice']['invoice_currency_code']); ?></td>  
                        </tr>
                        </td>
