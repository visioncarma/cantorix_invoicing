...
CREATE SCHEMA IF NOT EXISTS `cantorix` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
USE `cantorix` ;

-- -----------------------------------------------------
-- Table `cantorix`.`cpn_subscription_plans`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_subscription_plans` (
...
-- -----------------------------------------------------
-- Table `cantorix`.`cpn_currencies`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_currencies` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`cpn_languages`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_languages` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`cpn_financial_years`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_financial_years` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sbs_subscriber_organization_details`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sbs_subscriber_organization_details` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sbs_subscribers`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sbs_subscribers` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_clients`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_clients` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_acr_clients_sbs_subscribers1`
    ...
    REFERENCES `cantorix`.`sbs_subscribers` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_client_custom_fields`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_client_custom_fields` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_client_custom_values`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_client_custom_values` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_client_contacts`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_client_contacts` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sls_quotations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sls_quotations` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`inv_inventories`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`inv_inventories` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(155) NULL ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sbs_subscriber_taxes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sbs_subscriber_taxes` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(45) NOT NULL ,
  `code` VARCHAR(15) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sbs_subscriber_tax_groups`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sbs_subscriber_tax_groups` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sls_quotation_products`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sls_quotation_products` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sbs_subscriber_tax_group_mappings`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sbs_subscriber_tax_group_mappings` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sls_quotation_custom_fields`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sls_quotation_custom_fields` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `field_name` VARCHAR(255) NULL ,
  `sbs_subscriber_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sls_quotation_custom_values`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sls_quotation_custom_values` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `data` VARCHAR(255) NULL ,
  ...
  CONSTRAINT `fk_quotation_custom_values_sls_quotation_custom_fields1`
    ...
    REFERENCES `cantorix`.`sls_quotation_custom_fields` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_client_invoices`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_client_invoices` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_invoice_details`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_invoice_details` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_invoice_details_acr_client_invoices1`
    ...
    REFERENCES `cantorix`.`acr_client_invoices` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_invoice_custom_fields`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_invoice_custom_fields` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `field_name` VARCHAR(255) NULL ,
  `sbs_subscriber_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_invoice_custom_values`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_invoice_custom_values` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `data` VARCHAR(255) NULL ,
  `acr_client_invoice_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_acr_invoice_custom_values_acr_invoice_custom_fields1`
    ...
    REFERENCES `cantorix`.`acr_invoice_custom_fields` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_client_recurring_invoices`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_client_recurring_invoices` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_invoice_payment_details`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_invoice_payment_details` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acp_expense_categories`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acp_expense_categories` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acp_expenses`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acp_expenses` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `date` DATE NOT NULL ,
  ...
  CONSTRAINT `fk_acp_expenses_acp_expense_categories1`
    ...
    REFERENCES `cantorix`.`acp_expense_categories` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cantorix`.`users`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`users` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- Table `cantorix`.`aros`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`aros` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `parent_id` INT NULL ,
...
-- Table `cantorix`.`acos`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acos` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `parent_id` INT NULL ,
  `model` VARCHAR(55) NULL ,
  `foreign_key` INT NULL ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`aros_acos`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`aros_acos` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `aro_id` INT NOT NULL ,
  `aco_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_table1_aros1`
    FOREIGN KEY (`aro_id` )
    REFERENCES `cantorix`.`aros` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_table1_acos1`
    FOREIGN KEY (`aco_id` )
    REFERENCES `cantorix`.`acos` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cantorix`.`acp_inventory_expenses`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acp_inventory_expenses` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `quantity` INT NOT NULL ,
  ...
  CONSTRAINT `fk_acp_inventory_expenses_acp_expenses1`
    ...
    REFERENCES `cantorix`.`acp_expenses` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cantorix`.`acr_inventory_invoices`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`acr_inventory_invoices` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `acr_client_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_acr_inventory_invoices_acp_inventory_expenses1`
    ...
    REFERENCES `cantorix`.`acp_inventory_expenses` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cantorix`.`cpn_subscriber_invoice_details`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_subscriber_invoice_details` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`sbs_subscriber_settings`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`sbs_subscriber_settings` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cantorix`.`cpn_recurring_invoices`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_recurring_invoices` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cantorix`.`cpn_settings`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_settings` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `lines_per_page` TINYINT NULL ,
  `date_format` VARCHAR(10) NULL ,
  `currency_name` VARCHAR(35) NULL ,
  `currency_code` VARCHAR(10) NULL ,
  `payment_period` INT NULL ,
  `payment_frequency` TINYINT NULL ,
  `payment_cycle` ENUM('weekly','monthly','yearly') NULL ,
  `payment_type` ENUM('credit card','paypal') NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `cantorix`.`cpn_user_details`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `cantorix`.`cpn_user_details` (
  `id` INT NOT NULL AUTO_INCREMENT ,
