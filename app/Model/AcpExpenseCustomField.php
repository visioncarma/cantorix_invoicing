 ...
 */
	...
	public function getFieldByName($fieldName,$subscriberId){
		$getList  = $this->find('first',array('conditions'=>array('AcpExpenseCustomField.sbs_subscriber_id'=>$subscriberId,'AcpExpenseCustomField.field_name'=>$fieldName),'fields'=>array('AcpExpenseCustomField.id','AcpExpenseCustomField.field_name')));
		return $getList;
	}
