 ...
 */
	...
	public function getFieldByName($fieldName,$subscriberId){
		$getList  = $this->find('first',array('conditions'=>array('InvInventoryCustomField.sbs_subscriber_id'=>$subscriberId,'InvInventoryCustomField.field_name'=>$fieldName),'fields'=>array('InvInventoryCustomField.id','InvInventoryCustomField.field_name')));
		return $getList;
	}
}
