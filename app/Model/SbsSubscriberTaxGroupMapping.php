 ...
 */
	...
	public function getCompoundGroupMapping($groupId = null){
		$this->recursive = -1;
		$compoundedMappingInfo = $this->find('first',array('conditions'=>array('SbsSubscriberTaxGroupMapping.sbs_subscriber_tax_group_id'=>$groupId,'SbsSubscriberTaxGroupMapping.compounded'=>'Y'),'order'=>array('SbsSubscriberTaxGroupMapping.priority Asc'),'fields'=>array('SbsSubscriberTaxGroupMapping.compounded','SbsSubscriberTaxGroupMapping.id')));
		return $compoundedMappingInfo;
	}
	...
	public function checkTaxPresentGroup($tax_id=null){
		$taxMapping= $this->find('first',array('conditions'=>array('SbsSubscriberTaxGroupMapping.sbs_subscriber_tax_id'=>$tax_id),'fields'=>array('SbsSubscriberTaxGroupMapping.sbs_subscriber_tax_group_id','SbsSubscriberTaxGroupMapping.compounded','SbsSubscriberTaxGroupMapping.priority')));
	    if($taxMapping['SbsSubscriberTaxGroupMapping']['compounded'] == 'Y'){
	    	$taxGroupList = $this->find('list',array('conditions'=>array('SbsSubscriberTaxGroupMapping.sbs_subscriber_tax_group_id'=>$taxMapping['SbsSubscriberTaxGroupMapping']['sbs_subscriber_tax_group_id'],'SbsSubscriberTaxGroupMapping.priority <'=>$taxMapping['SbsSubscriberTaxGroupMapping']['priority']),'order'=>array('SbsSubscriberTaxGroupMapping.priority ASC'),'fields'=>array('SbsSubscriberTaxGroupMapping.sbs_subscriber_tax_id')));	
	    	return $taxGroupList;
	    }else{
	    	return false;
	    }
