 ...
 */
	...
	public function getFieldByName($fieldName,$subscriberId){
		$getList  = $this->find('first',array('conditions'=>array('AcrInvoicePaymentDetailCustomField.sbs_subscriber_id'=>$subscriberId,'AcrInvoicePaymentDetailCustomField.field_name'=>$fieldName),'fields'=>array('AcrInvoicePaymentDetailCustomField.id','AcrInvoicePaymentDetailCustomField.field_name')));
		return $getList;
	}
}
