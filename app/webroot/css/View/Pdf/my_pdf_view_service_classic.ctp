...
/*** Table starts here **/ 
	...
	$heading_part ='<table style="border-bottom: 1px solid #2E2E2E;">
                    ...
                    <td style="width:125;float:left;text-align:left;font-family: Arial; font-size: 30px; font-weight: bold;">
                    	'.nl2br("INVOICE\n").'<span style="font-family: Arial;">  Inv #</span><span style="font-family: Arial;font-weight: bold;">  '.$invoiceData['AcrClientInvoice']['invoice_number'].'</span>
                    </td>' .
   ...
   $addresspart ='<table>
	...
	$datepart ='<table>
                 ...
                 <tr style="float:left;background-color:#FFFFFF;"><td style="width:5px;float:left;color:#0f6082;"></td>
                    <td style="width:46px;float:left;color:#0f6082;"></td>
                    <td style="width:100px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">
                   		'.$invoiceData['AcrClientInvoice']['invoiced_date'].'
                    </td>
                    <td style="width:100px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">
                   		'.$invoiceData['SbsSubscriberPaymentTerm']['no_of_days'].' Days Nett
                    </td>
                    <td style="width:100px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">
                   		'.$invoiceData['AcrClientInvoice']['due_date'].'
                    </td>
                    <td style="width:50px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">
	...
	$items.='<tr style="float:left;background-color:#FFFFFF;">
				<td style="width:10px;float:left;color:#0f6082;"></td>
                    <td style="border-bottom: 1px solid #2E2E2E;width:100px;float:left;font-family:Arial;text-align:left; font-size: 10pt;">'.$v['InvInventory']['name'].'</td>
	...
	$payements.='<tr style="float:left;background-color:#FFFFFF;">
      ...
      $payements.='
				...
				<td style="width:10px;float:left;color:#0f6082;"></td>
                    ...
                    <td style="border-bottom: 1px solid #2E2E2E;width:75px;float:left;font-family:Arial;text-align:right; font-size: 10pt;">'.$this->Number->currency($download_pay,$subscriberCurrencyCode).'</td>
                 </tr>
                 <tr style="float:left;background-color:#FFFFFF;">
				<td style="width:10px;float:left;color:#0f6082;"></td>
                    <td style="width:100px;float:left;font-family:Arial;text-align:left; font-size: 10pt;"></td>
                    ...
                    <td style="width:75px;float:left;font-family:Arial;text-align:right; font-weight:Bold;font-size: 10pt;">'.$this->Number->currency($download_due,$subscriberCurrencyCode).'</td>
                 </tr>
                 <tr style="float:left;background-color:#FFFFFF;">
...
$html = <<<EOD
	...
	<table  cellpadding="0">
	  ...
	  <tr>
	    ...
	    <th style="width:75px;border-bottom: 1px solid #2E2E2E;font-family:Arial;font-weight:Bold;text-align:left; font-size: 10pt;">Rate</th>
