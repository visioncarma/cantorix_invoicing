<div class="sbsSubscriberTaxGroups index">
	<h2><?php echo __('Sbs Subscriber Tax Groups'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('group_name'); ?></th>
			<th><?php echo $this->Paginator->sort('compounded'); ?></th>
			<th><?php echo $this->Paginator->sort('sbs_subscriber_id'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($sbsSubscriberTaxGroups as $sbsSubscriberTaxGroup): ?>
	<tr>
		<td><?php echo h($sbsSubscriberTaxGroup['SbsSubscriberTaxGroup']['id']); ?>&nbsp;</td>
		<td><?php echo h($sbsSubscriberTaxGroup['SbsSubscriberTaxGroup']['group_name']); ?>&nbsp;</td>
		<td><?php echo h($sbsSubscriberTaxGroup['SbsSubscriberTaxGroup']['compounded']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $sbsSubscriberTaxGroup['SbsSubscriberTaxGroup']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $sbsSubscriberTaxGroup['SbsSubscriberTaxGroup']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $sbsSubscriberTaxGroup['SbsSubscriberTaxGroup']['id']), null, __('Are you sure you want to delete # %s?', $sbsSubscriberTaxGroup['SbsSubscriberTaxGroup']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
