<?php $taxChange=$this->requestAction('taxes/taxPercentChange/'.$id);?>
                                  ...
                                  <div class="model-body-inner-content"> 
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-sm-8">
			                              ...
			                              <?php if($taxChange){
			                              	        echo $this->Form->input('tax_percent.'.$id,array('div'=>FALSE,'label'=>FALSE,'class'=>'input-mini col-xs-10 col-sm-5 form-control','value'=>$taxIdDetails['SbsSubscriberTax']['percent']));
										        }else{
