...
<!--<?php echo $this->Html->script(array('jquery-ui-1.10.3.full.min')); ?>-->
    ...
    <div class="row taxscreen">
		...
		<div id="tabs" class="custom-tab">
				<ul class=" customtablist">
					...
					<!--a href="#tabs-1" class="bold"><i class="taxicon"></i>Taxes</a-->
					...
					<li id="forgrp"  class="addtaxgroups">
					 <!--a href="#tabs-2" class="bold"><i class="taxicongroup"></i>Tax Groups</a-->
					 	<?php echo $this->Js->link('<i class="taxicongroup"></i>Tax Groups', array (
										...
										?>
					 	 <?php /*echo $this->Html->link('<i class="taxicongroup"></i>Tax Groups',array('controller'=>'TaxGroups','action'=>'index'),array('class'=>'bold','escape'=>FALSE));*/?>
					</li>
				...
				<div id="tabs-1">
					<div class="pull-right  bottommarginn newaddtax">
						   ...
						   <?php echo $this->Html->link('<i class="icon-plus"></i>Add Tax',array('controller'=>'taxes','action'=>'add'),array('class'=>'btn btn-sm btn-success pull-right addbutton','escape'=>FALSE));?>
					</div>
                     ...
                     <?php echo $this->Form->create('SbsSubscriberTax');?>  
						<div class="row margin-twenty-zero">
                                ...
                                <div class="form-group filed-left margin-bottom-zero">
                                 <?php echo $this->Form->input('name',array('class'=>'tName','type'=>'text','label'=>false,'div'=>false,'placeholder'=>'Tax Name')); ?>
                                </div>
                           		<div class="form-group filed-left margin-bottom-zero">
                                  <?php echo $this->Form->input('code',array('class'=>'tCode','type'=>'text','label'=>false,'div'=>false,'placeholder'=>'Tax Code')); ?>
                                </div>                                                    
                            	<div class="form-group filed-left margin-bottom-zero">
                            		<?php echo $this->Js->submit('Filter', array('div'=>false,'class'=>'btn btn-sm btn-primary filter-btn taxfilter','url' => array('controller'=>'taxes','action' => 'index'),'escape'=>false,'update' => '#pageContent'));?>
                            	   <?php /*echo $this->Form->submit('Filter',array('url'=>array('controller'=>'taxes','action'=>'index'),'class'=>'btn btn-sm btn-primary filter-btn','div'=>false));*/?>
                                </div>
                        </div>
							...
							<?php $i=0; foreach($sbsSubscriberTaxes as $key=>$value): $i++; ?>
								...
								<tr id = "tr-<?php echo $value['SbsSubscriberTax']['id']?>">
                                	<td>	
                                    	<span class="">
                                            <label>
                                                 <?php echo $this->Form->input('Delete.'.$value['SbsSubscriberTax']['id'],array('type'=>'checkbox','div'=>FALSE,'label'=>FALSE,'class'=>'ace delete-m-row'));?>
                                                <span class="lbl"></span>
                                            </label>
                                         </span>   
                                    </td>
									...
									<td>
                                    	<span class="on-load"><?php echo $value['SbsSubscriberTax']['name']; ?></span>
                                    	 <?php //echo $this->Form->input('tax_name.'.$value['SbsSubscriberTax']['id'],array('class'=>'on-edit','type'=>'text','label'=>false,'div'=>false,'value'=>$value['SbsSubscriberTax']['name'])); ?>
                                    </td>
									<td class="hidden-480">
                                    	<span class="on-load"><?php echo $value['SbsSubscriberTax']['code']; ?></span>
                                        <?php //echo $this->Form->input('tax_code.'.$value['SbsSubscriberTax']['id'],array('class'=>'on-edit','type'=>'text','label'=>false,'div'=>false,'value'=>$value['SbsSubscriberTax']['code'])); ?>
                                    </td>
									<td>
                                    	<span class="on-load taxpercentageright"><?php echo number_format((float)$value['SbsSubscriberTax']['percent'], 2, '.', '');?>%</span>
                                        <?php $percentage = range(0,200);
                                        		
                                              if($taxChange){ 
                                              	 //echo $this->Form->input('tax_percent.'.$value['SbsSubscriberTax']['id'],array('class'=>'on-edit','label'=>false,'div'=>false,/*'options'=>array(''=>'select',$percentage),*/'value'=>$value['SbsSubscriberTax']['percent'])); 
                                              }
											  else{
											  	 //echo $this->Form->input('tax_percent.'.$value['SbsSubscriberTax']['id'],array('class'=>'on-edit','label'=>false,'div'=>false,'readonly'=>true,/*'options'=>array(''=>'select',$percentage),*/'value'=>$value['SbsSubscriberTax']['percent'])); 
											  }
									...
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											...
											<?php if($permission['_delete'] == 1){ 
													...
													array('action' => 'delete',$value['SbsSubscriberTax']['id']), array('confirm'=>'Are you sure you want to delete the tax ?','escape'=>FALSE,'update'=>'#tr-'.$value['SbsSubscriberTax']['id'])); 
                                                           ...
                                                           <div class="model-body-inner-content"> 
												                        ...
												                        <div class="form-group">
												                            ...
												                            <div class="col-sm-8 col-xs-12 nopaddingmobile">
												                              ...
												                              <?php if($taxChange){
												                              	           echo $this->Form->input('tax_percent.'.$value['SbsSubscriberTax']['id'],array('div'=>FALSE,'label'=>FALSE,'class'=>'input-mini col-xs-12 col-sm-5 form-control','value'=>$value['SbsSubscriberTax']['percent']));
																					 }else{
