...
<?php echo $this->Form->create('CpnSubscriptionPlan'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cpn Subscription Plan'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CpnSubscriptionPlan.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CpnSubscriptionPlan.id'))); ?></li>
