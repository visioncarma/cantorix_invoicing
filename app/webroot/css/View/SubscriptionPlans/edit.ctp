<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li>
			<?php echo $this->Html->link(__('Settings'),array('controller'=>'Currencies','action'=>'index'));?>
		</li>
		<li>
			<?php echo $this->Html->link(__('Subscription Plans'),array('controller'=>'SubscriptionPlans','action'=>'index'));?>
		</li>
		<li class="active">
			<?php echo __('Edit Subscription Plans');?>
		</li>
	</ul><!-- .breadcrumb -->
</div>
...
<div class="page-content">
	<div class="page-header">
		<h1> <?php echo __('Edit Subscription Plans');?> </h1>
		...
		<div class="col-xs-12">
			<?php echo $this->Form->create('CpnSubscriptionPlan',array('class'=>'form-horizontal','role'=>'form')); ?>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo __('Plan Type');?></label>

					<div class="col-sm-10">
						<?php echo $this->Form->input('type',array('label'=>false,'div'=>false,'class'=>'col-xs-10 ol-sm-5 col-lg-3','id'=>'form-field-1','type'=>'text','readonly'=>'readonly','disabled'=>'disabled'));?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<?php echo $this->Form->input('validity',array('label'=>false,'type'=>'text','div'=>false,'class'=>'col-xs-10 ol-sm-5 col-lg-3','id'=>'form-field-2'));?>
						<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="Enter the validity in days.For unlimited validity enter -1">?</span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="Enter number staffs allowed per subscription.For unlimited staffs enter -1">?</span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="Enter number of clients per subscription.For unlimited clients enter -1">?</span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="Enter number of invoices per subscription.For unlimited invoices enter -1">?</span>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<?php echo $this->Form->input('cost',array('id'=>'form-field-6','div'=>false,'label'=>false,'type'=>'text','class'=>'col-xs-10 ol-sm-5 col-lg-3','value'=>number_format((float)$data['CpnSubscriptionPlan']['cost'], 2, '.', '')));?>
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
				...
				<div class="clearfix form-actions margintopzero ">
					<div class="col-md-offset-2 col-md-3 nopaddingleft nopaddingright">
						...
						<?php echo $this->Html->link('<div class="btn btn-inverse"><i class="icon-remove bigger-110"></i>Cancel</div>', array('action' => 'index'),array('escape'=>false)); ?>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
 	...
 	$("#CpnSubscriptionPlanEditForm").validate({
		 rules: {  	
