			...
			<div class="col-lg-12 col-xs-12 col-sm-12 col-md-12 paddingleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-sm-3 col-lg-2 col-md-3 col-xs-12 marginleftrightzero paddingleftrightzero">
							<?php echo $this->Form->input('cpn_language_id',array('options'=>array($languageList),'default'=>$final['organisationDetail']['SbsSubscriberOrganizationDetail']['cpn_language_id'],'class'=>'selectpicker form-control'));?>
						</div>
					</div>
				</div>
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-sm-3 col-lg-2 col-md-3 col-xs-12 marginleftrightzero paddingleftrightzero">
							<?php echo $this->Form->input('cpn_financial_id',array('options'=>array($financialYearList),'default'=>$final['organisationDetail']['SbsSubscriberOrganizationDetail']['cpn_financial_year_id'],'class'=>'selectpicker form-control'));?>
						</div>
					</div>
				</div>
				<div class="row marginleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-sm-3 col-lg-2 col-md-3 col-xs-12 paddingleftrightzero marginleftrightzero countrybilling">
							<?php echo $this->Form->input('billing_country_code',array('options'=>array(''=>'Select country',$countryList),'default'=>$final['organisationDetail']['SbsSubscriberOrganizationDetail']['billing_country_code'],'class'=>'selectpicker form-control'));?>
						</div>
					</div>
				</div>
				<div class="row marginleftrightzero">
				...
				<div class="row marginleftrightzero optionselect">
					<div class="form-group marginleftrightzero">
						<label class="col-sm-3 col-lg-2 col-md-3 col-xs-12 control-label paddingleftrightzero marginleftrightzero" > Country </label>
						<div class="col-sm-3 col-lg-2 col-md-3 col-xs-12 paddingleftrightzero marginleftrightzero">
							<?php echo $this->Form->input('shipping_country_code',array('options'=>array(''=>'Select country',$countryList),'default'=>$final['organisationDetail']['SbsSubscriberOrganizationDetail']['shipping_country_code'],'class'=>'selectpicker form-control'));?>
						</div>
					</div>
				</div>
				<div class="row marginleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-sm-3 col-lg-2 col-md-3 col-xs-12 paddingleftrightzero marginleftrightzero">
							<?php echo $this->Form->input('time_zone',array('options'=>array($final['time_zones']),'default'=>$final['organisationDetail']['SbsSubscriberOrganizationDetail']['time_zone'],'class'=>'selectpicker form-control'));?>
						</div>
				...
				<div class="row marginleftrightzero">
					<div class="col-sm-offset-3  col-lg-offset-2 col-md-offset-3 col-md-7 col-lg-3 col-xs-12 paddingleftrightzero">
						<?php echo $this->Form->button('<i class="icon-save bigger-110"></i>Submit',array('escape'=>FALSE,'class'=>'btn btn-info','type'=>'submit'));?>
						<?php echo $this->Html->link('<i class="icon-remove bigger-110"></i> Cancel',array('action'=>'organisationProfile'),array('class'=>'btn','escape'=>FALSE));?>
					</div>
				</div>
			</div>
		</div>
	...
	$(function(){
		...
		$( "input#identitcal" ).on( "click", function(){
			if($(this).is(':checked')) {
				...
				//var countrytext = $("#OrganisationProfileBillingCountryCode").find(":selected").text();
				//console.log(country);
				//$("select[name='data[OrganisationProfile][shipping_country_code]']").val(country);
				//$('.optionselect .bootstrap-select span.filter-option').text(countrytext);
