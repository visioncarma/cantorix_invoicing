    ...
    <!-- /.page-header -->      
      <div class="row paddingtop100">
                ...
                <div class="profilethumpnail profile-picture" style="cursor:pointer">
                	...
                	<img id="imgprvw" class="img-responsive" src="<?php echo $this->webroot.'/'.$user_detail['User']['profile_picture_path'];?>"  alt="profilepic"/>
...
$(document).ready(function(){ 
	...
	$.validator.addMethod("emailexist",function(value,element){			
		 var x= $.ajax({
		    url: "/cantorix/subscribers/emailexist",
		    type: 'GET',
		    async: false,
	...
	$.validator.addMethod("usernameexist",function(value,element){			
		 var x= $.ajax({
		    url: "/cantorix/subscribers/usernameexist",
		    type: 'GET',
		    async: false,
