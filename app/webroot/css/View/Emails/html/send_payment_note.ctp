		...
		<table cellspacing="0" style="width:600px;padding:0px; background:#fff; height:100%; border:1px solid #d8d8d8; margin:auto; align:center; cellpadding:0; cellspacing:0; bgcolor:#ffffff;">
			...
			<tr>
				...
				<p style="padding:20px 10px;background:#86B559;">
					<span style="font-size:14px;font-family:arial;color:#fff;font-weight:normal;">Payment Status</span></br>
					<span style="font-size:20px;font-family:arial;color:#fff;font-weight:bold;">Completed.</span>
				</p></td>
			</tr>
			<tr>
				<td style="padding:0px 30px;font-size:14px;font-family:arial;color:#666666;font-weight:normal;"> Dear <?php echo $client_name; ?>, </td>
			</tr>
			<tr>
				<td  style="padding: 7px 0; padding-left:10px;font-size:13px;font-family:arial;color:#ffffff;"></td>
			</tr>
			<tr>
				<td style="padding:0px 30px;font-size:14px;font-family:arial;color:#666666;font-weight:normal;"> Thank you For Payment.</td>
			</tr>
		</table></td>
	</tr>
	<tr>
