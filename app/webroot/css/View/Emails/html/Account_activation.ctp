<?php
	...
	$resetLink = "$protocol_final".'://'."$http_hostname"."$webroot_name".'users/confirmResetPassword?param='."$encrypt_key";
?>
		...
		<table cellspacing="0" style="width:600px;padding:0px; background:#fff; height:100%; border:1px solid #d8d8d8; margin:auto; align:center; cellpadding:0; cellspacing:0; bgcolor:#ffffff;">
			...
			<tr>
				...
				<p style="padding:20px 10px;background:#86B559;">
					...
					<span style="font-size:20px;font-family:arial;color:#fff;font-weight:bold;">Please Verify your email address.</span>
				</p></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="padding:0px 30px;font-size:14px;font-family:arial;color:#666666;font-weight:normal;"> To verify your email address,please click on the button below. You will then be asked to confirm your password. </td>
			</tr>
			<tr>
				<td  style="padding: 7px 0; padding-left:10px;font-size:13px;font-family:arial;color:#ffffff;"></td>
			</tr>
			<tr>
				...
				<p style="padding:10px;background:#2C83B8;width:200px;">
					<a style="font-size:16px;font-family:arial;color:#fff;font-weight:bold;text-decoration:none;" href="<?php echo $resetLink;?>">Verify your email address</a>
				</p></td>
			</tr>
			<tr>
