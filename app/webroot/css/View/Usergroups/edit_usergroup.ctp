			...
			<div class="table-responsive table-responsivenoscroll">
				<div class="row margin-twenty-zero filterdivmob">
					<div class="form-group margin-bottom-zero role-form-group">
						<label class="col-sm-2 control-label no-padding-right no-padding-left col-xs-12 col-lg-1" for="form-field-1">Role name</label>
				...
				<div class="row">
					...
					<div class="col-sm-12 col-sm-12 col-xs-12 marginbottomm ">
						<?php echo $this->Html->link('<i class="icon-remove bigger-110"></i>Cancel',array('action'=>'manageUsergroup'),array('class'=>'btn pull-right margin-left-15 btn-inverse','escape'=>FALSE));?>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$.validator.addMethod("checkEmailAvailability",function(value,element){				
			var x= $.ajax({
			    url: "<?php echo $protocol_final.'://'.$_SERVER['SERVER_NAME'].$this->webroot;?>usergroups/checkRole/1",
			    type: 'POST',
			    async: false,
