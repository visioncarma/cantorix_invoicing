					...
					<tbody>
						...
						<tr id="tr-<?php echo $user['User']['id'];?>">
							<td>
								...
								<?php echo $this->Form->input($user['User']['id'].'.user_name',array('placeholder'=>'User Name','value'=>$user['User']['username'],'disabled'=>'disabled','class'=>'on-edit width120'));?>
							...
							<td>
								...
								<?php if($user['User']['id'] != $adminUser['Aro']['foreign_key']):?>
								<?php echo $this->Form->input($user['User']['id'].'.email',array('placeholder'=>'Email','value'=>$user['User']['email'],'disabled'=>'disabled','class'=>'on-edit width120'));?>
							...
							<td>
								...
								<?php if($user['User']['id'] != $adminUser['Aro']['foreign_key']):?>
								<?php echo $this->Form->input($user['User']['id'].'.aro_id',array('class'=>'on-edit','data-placeholder'=>'Role','options'=>array($user_groups),'default'=>$groupName['Aro']['id']));?>
								<?php endif;?>
							</td>
							<td><span class="on-load"><?php if($user['User']['active'] == 'Y') {echo 'Yes';} else { echo 'No'; }?></span>
								<?php if($user['User']['id'] != $adminUser['Aro']['foreign_key']):?>
								<?php echo $this->Form->input($user['User']['id'].'.active',array('class'=>'on-edit','data-placeholder'=>'Role','options'=>array('Y'=>'Yes','N'=>'No'),'default'=>$user['User']['active']));?>
								<?php endif;?>
							</td>
							<td>
							<div class="btn-group">
