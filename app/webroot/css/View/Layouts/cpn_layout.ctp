...
<html lang="en">
	<head>
		...
		?>
		<?php
	   		echo $this->Html->script(array('jquery-2.0.3.min.js','jquery-ui-1.10.3.custom.min.js','bootstrap.min.js','typeahead-bs2.min.js','ace-elements.min.js','ace.min.js','jquery.validate.min.js','ace-extra.min.js','additional-methods.js','bootstrap-select.js','admin_dashboard_js.js','chosen.jquery.min.js','bootstrap-datepicker.min.js','jquery.placeholder.js'));
		?>
