	...
	<div class="page-header">
		...
		<div class="col-lg-2 paddingleftrightzero">
			<?php if($permission['_create'] == 1):?>
				<button class="btn btn-sm btn-success pull-right addbutton margintop15" data-toggle="modal" data-target="#addnewcurrency">
					<i class="icon-plus"></i>
					Add New Currency
				</button>
			<?php endif;?>
					...
					<?php echo $this->Form->hidden('editCurrency.filterValue',array('value'=>$value));?>
						...
						<tr>
							...
							<td>
								...
								<?php echo $this->Form->input('editCurrency.code.'.$cpnCurrency['CpnCurrency']['id'],array('div'=>false,'label'=>false,'type'=>'text','class'=>'on-edit cname-edit','placeholder'=>'Currency Code','value'=>$cpnCurrency['CpnCurrency']['code']));?>
							</td>
							<td >
								<span class="on-load ccode-load"><?php echo h($cpnCurrency['CpnCurrency']['name']); ?>&nbsp;</span>
								<?php echo $this->Form->input('editCurrency.name.'.$cpnCurrency['CpnCurrency']['id'],array('div'=>false,'label'=>false,'type'=>'text','class'=>'on-edit ccode-edit','placeholder'=>'Currency Name','value'=>$cpnCurrency['CpnCurrency']['name']));?>
							</td>
							<?php if($permission['_update'] == 1 || $permission['_delete'] == 1):?>
							<td>
         ...
         <div class="model-body-inner-content">             
                  <div class="form-group login-form-group">
                    ...
                    <div class="col-sm-8 ssh_keys_popup_input col-sx-12 nopaddingmobile">
                    	<?php echo $this->Form->input('code',array('div'=>false,'label'=>false,'type'=>'text','class'=>'form-control','placeholder'=>'For example ZAR, USD etc'));?>
