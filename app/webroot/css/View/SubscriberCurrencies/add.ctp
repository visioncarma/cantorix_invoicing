		...
		<div class="col-xs-12">
			<div class="table-responsive table-responsivenoscroll">
				...
				<?php echo $this->Form->create('filterCurrency',array('id'=>'filterCurrencyId','url'=>array('controller'=>'subscriber_currencies','action'=>'add')));?>                                            	    
                    <div class="form-group filed-left margin-bottom-zero form-filter-field col-xs-12 nopadding col-lg-2 col-sm-5">
                     ...
                     <div class="form-group filed-left margin-bottom-zero form-filter-field col-xs-12 col-lg-2 col-sm-6 nopadding">
                 ...
                 <?php echo $this->Form->create('editCurrency',array('class'=>'custom-form-sl','role'=>'form','id'=>'editCurrency'));?>
					 <div class="col-lg-2 paddingleftrightzero" style="float:right;">
						<?php echo $this->Js->submit('Add Selected Currencies', array('url' => '/SubscriberCurrencies/multiCurrenyAdd',$filterBy,$value,$pages,'label'=>false,'div'=>false,'class'=>'btn btn-sm btn-primary filter-btn form-control','style'=>array('border-top-width: 0;margin-bottom: 0;margin-left: -86px;margin-right: 0;margin-top: -298px;'),'update' =>'#pageContent'));?>
					 </div>
				<table id="sample-table-1" class="table table-striped table-bordered table-hover editable-table">
					<thead>
						<tr>
							...
							<th><?php echo $this->Paginator->sort('code','Currency Code'); ?></th>
							<th ><div class="btn-group"> <?php echo $this->Paginator->sort('name','Currency Name'); ?></div></th>
	                                ...
	                                <ul class="pagination">
	                                	<?php
											$this->Paginator->options(array(
		     									'update' => '#pageContent',
												'evalScripts' => true,
												'url' => array('controller'=>'SubscriberCurrencies','action'=>'add',$filterBy,$value),
