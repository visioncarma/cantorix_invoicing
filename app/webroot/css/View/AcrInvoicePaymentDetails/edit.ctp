			...
			<div class="col-lg-8 paddingleftrightzero">
				...
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero relative">
						<label  class="col-xs-12 col-sm-3 col-lg-4  control-label marginleftrightzero paddingleftrightzero">Payment Method</label>
						<div class="col-xs-12 col-sm-3 col-lg-3  marginleftrightzero paddingleftrightzero labelerror">							
							<?php echo $this->Form->input('payment_method',array('div'=>FALSE,'label'=>FALSE,'class'=>'form-control selectpicker selectitem','options'=>array(''=>'Select',$paymentMethods),'default'=>$paymentData['CpnPaymentMethod']['id']));?>
						</div>
					</div>
				</div>
				<div class="row marginleftrightzero">
					<div class="form-group marginleftrightzero">
						...
						<div class="col-sm-3 marginleftrightzero paddingleftrightzero">
							<div class="col-sm-3 marginleftrightzero paddingleftrightzero">								
								<?php echo $this->Form->input('invoice_currency',array('div'=>FALSE,'label'=>FALSE, 'id'=>'editPaymentInvoiceCurrency','value'=>$paymentData['AcrClientInvoice']['invoice_currency_code'], 'class'=>'form-control text-center bold','disabled'=>"disabled"));?>  
							</div>
					...
					<div class="form-group marginleftrightzero">
						...
						<div class="col-sm-2 marginleftrightzero paddingleftrightzero">
							<div class="input-group custom-datepicker">														
								...
								echo $this->Form->input('payment_date',array('div' => false , 'label'=>false, 'id'=>"", 'class'=>"form-control date-picker", 'data-date-format'=>str_ireplace('y','yyyy',$date_format), 'readonly'=>'readonly','style'=>'cursor:default','default'=>$paymntdate)); ?>
		...
		<div class="row marginleftrightzero paddingbottom20">
			<div class="clearfix margintopzero paddingtopzero no-padding-left no-padding-right">
				<div class="col-md-offset-3">
					<?php echo $this->Form->button("<i class='icon-ok bigger-110'></i> Submit", array('div'=>false,'class'=>'btn btn-info onsubmit','url' => array('controller'=>'AcrInvoicePaymentDetails','action' => 'edit'),'escape'=>false));?>
					<?php echo $this->Html->link('<i class="icon-remove bigger-110"></i> Cancel',array('action'=>'index',$filterAction, $filterValue, $filterValue1, $filterValue2, $fromDate, $toDate, 'page:'.$page),array('class'=>'btn btn-inverse','escape'=>FALSE));?>
				</div>
			</div>
		</div>
