<!--<?php echo $this->Html->css(array('selectbox.css')); ?>
<?php echo $this->Html->script(array('jquerySelectbox')); ?>-->
...
<div class="page-content">
	<div class="page-header">
		...
		<div class="col-lg-6 col-sm-12 col-md-12  col-xs-12 paddingleftrightzero pull-right">		
			<?php echo $this->Html->link('<i class="icon-plus"></i>Add Customer',array('action'=>'add'),array('class'=>'col-lg-4 col-xs-12 col-sm-4 col-md-4 btn btn-sm btn-success pull-right addbutton marginleft2 paddingnewadd','escape'=>FALSE));?>
		
			<?php echo $this->Html->link('<i class="icon-caret-down icon-on-right"></i>Import Customer',array('action'=>'show_excel'),array('class'=>'col-xs-12 col-lg-4 col-sm-4 col-md-4 btn btn-sm btn-success pull-right importbutton','escape'=>FALSE));?>
			<!--button class="btn btn-sm btn-success pull-right importbutton" data-toggle="modal" data-target="#addnewuser">
				Import Customer
		...
		<div class="col-xs-12">
			<div class="table-responsive table-responsivenoscroll overflowvisible tablehidemobilee">
				...
				<div class="row margin-twenty-zero filterdivmob">
					...
					<div class="form-group filed-left margin-bottom-zero form-filter-field col-xs-12 nopadding col-lg-2 col-md-4 col-sm-4">                    	                    	
                    	<?php echo $this->Form->input('status',array('class'=>'form-control selectpicker col-xs-12 ','data-placeholder'=>'Status','options'=>array('Status','active'=>'Active','inactive'=>'Inactive')));?>                    	
                     </div>
				...
				<div  class="row magin-delete-all hidden-480">
                 <span class="deleteicon delete" title="Delete All"><i class="icon-trash bigger-120" style="color:#F00;"></i></span>
                </div> 
				<table id="sample-table-1" class="table table-striped table-bordered table-hover editable-table">
					<thead>
						<tr>
							...
							<th class="hidden-md visible-lg visible-sm  visible-xs btn-group"> <div > Organisation Name </div></th>
							<th><div class="visible-md visible-lg visible-sm hidden-xs btn-group">Customer Name</div></th>
							<th><div class="visible-md visible-lg hidden-sm hidden-xs btn-group"> Contact Email</div></th>
							<th><div class="visible-md visible-lg visible-sm hidden-xs btn-group"> Business Phone</div></th>
							<th><div class="visible-md visible-lg hidden-sm hidden-xs btn-group"> Active </div></th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="visible-md visible-lg visible-sm hidden-xs btn-group "><span class="on-load"><?php echo $value['AcrClient']['client_name'];?></span></div>
							</td>
							
							<td>
								<div class="visible-md visible-lg hidden-sm hidden-xs btn-group"><span class="on-load"><?php echo $value['Contact']['AcrClientContact']['email'];?></span></div>
							</td>
							<td>
							...
							<td>
								<div class="visible-md visible-lg hidden-sm hidden-xs btn-group"><span class="on-load" style="text-transform:capitalize;"><?php echo $value['AcrClient']['status'];?></span></div>
							</td>
							<td>
								...
								<div class="inline position-relative">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close ipadfix">
										...
										<li>
											<?php if($permission['_delete'] == 1){?>
												<!--//echo $this->Form->postLink('<i class="icon-trash bigger-120"></i>',array('action'=>'delete',$value['AcrClient']['id'],$organization,$client,$email,$status,$page),array('class'=>'btn btn-xs btn-danger delete on-load','title'=>'Delete','escape'=>FALSE), __('If there is an invoice for the client,client will be made inactive otherwise client will be removed from the system.'));-->
                                    ...
                                    <div class="pull-right">
										<div class="inline position-relative">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
												<li>
													<?php if($permission['_read'] == 1){
												echo $this->Form->postLink('<i class="icon-zoom-in bigger-120"></i>',array('action'=>'view',$value['AcrClient']['id'],$organization,$client,$email,$status,$page),array('class'=>'btn btn-xs btn-success view on-load','title'=>'View','escape'=>FALSE));
												} ?>												</li>

												<li>
													<?php if($permission['_update'] == 1){
											echo $this->Form->postLink('<i class="icon-edit bigger-120"></i>',array('action'=>'edit',$value['AcrClient']['id'],$organization,$client,$email,$status,$page),array('class'=>'btn btn-xs edit on-load','title'=>'Edit','escape'=>FALSE));
											}?>
												</li>
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									         <div class="model-body-inner-content">  
												 ...
												 <div class="center 14pfont paddingbottom">
												 	You are about to delete <span class="clientpopname">'<?php echo $value['AcrClient'][''];?>'</span>.
