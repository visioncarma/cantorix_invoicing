				  ...
				  <div class="manage_customer_view_left">
                   <div class="col-xs-12">
                      <div class="form-horizontal" >
                            <div class="form-group marginbottom5">
                                ...
                                <label class="col-sm-9 control-label no-padding-right bold no-padding-left " ><?php echo $client_detail['AcrClient']['organization_name']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Currency Code </label>            
                                <label class="col-sm-9 control-label no-padding-right bold no-padding-left " ><?php echo $client_detail['CpnCurrency']['code']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Language </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $client_detail['CpnLanguage']['language']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Send Invoices By </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " > 
                            ...
                            <div class="form-group marginbottom5">
                                ...
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $client_detail['AcrClient']['business_phone']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Business Tax </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $client_detail['AcrClient']['business_fax']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                             ...
                             <?php if($client_detail['AcrClient']['notes']){ ?>
                            	   <div class="form-group marginbottom5">
                                     <label class="col-sm-3 control-label no-padding-right no-padding-left " >Notes</label>           
                                     <label class="col-sm-9 control-label no-padding-right bolder no-padding-left"><?php echo $client_detail['AcrClient']['notes']; ?></label>
                                 </div>	
                            <?php } ?>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Payment Terms </label>           
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left"><?php echo $paymentTerm['SbsSubscriberPaymentTerm']['term']; ?></label>
                            </div>	
                   ...
                   <div class="col-xs-12">
                      <div class="form-horizontal" >
                            <div class="form-group marginbottom5">
                                ...
                                <label class="col-sm-9 control-label no-padding-right bold no-padding-left " ><?php echo $primary_client_contact['AcrClientContact']['name'];?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Contact Surname </label>            
                                <label class="col-sm-9 control-label no-padding-right bold no-padding-left " ><?php echo $primary_client_contact['AcrClientContact']['sur_name'];?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Contact Email </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $primary_client_contact['AcrClientContact']['email'];?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Mobile </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $primary_client_contact['AcrClientContact']['mobile'];?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Home Phone </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $primary_client_contact['AcrClientContact']['home_phone'];?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Work Phone </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $primary_client_contact['AcrClientContact']['work_phone'];?></label>
                            </div>                                                								
                      </div>
                   </div>
                   ...
                   <div class="col-xs-12">
                      <div class="form-horizontal" >
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Contact Name </label>            
                                <label class="col-sm-9 control-label no-padding-right bold no-padding-left " ><?php echo $value['AcrClientContact']['name']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Contact Surname </label>            
                                <label class="col-sm-9 control-label no-padding-right bold no-padding-left " ><?php echo $value['AcrClientContact']['sur_name']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Contact Email </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $value['AcrClientContact']['email']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Mobile </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $value['AcrClientContact']['mobile']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Home Phone </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $value['AcrClientContact']['home_phone']; ?></label>
                            </div>
                            <div class="form-group marginbottom5">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " > Work Phone </label>            
                                <label class="col-sm-9 control-label no-padding-right bolder no-padding-left " ><?php echo $value['AcrClientContact']['work_phone']; ?></label>
                            </div>                                                								
                      </div>
                   </div>
                    <?php } ?>
                   ...
                   <div class="col-xs-12">
                      <div class="form-horizontal" >
                            ...
                            <div class="form-group ">
                                <label class="col-sm-3 control-label no-padding-right no-padding-left " ><?php echo $v; ?></label>            
                                <label class="col-sm-9 control-label no-padding-right bold no-padding-left " ><?php echo $fieldValues[$k]; ?></label>
                            </div>
							<?php endforeach;?> 
						...
						<div class="widget-body">
							<div class="widget-main">
							  <div class="form-group">
                                ...
                                <label class="col-sm-7 control-label no-padding-right bold no-padding-left " >$ <?php echo $amount_due; ?></label>
                              </div> 
							</div>
						</div>
					</div>
