	...
	<div class="row">
		<div class="col-xs-12">
				...
				<div class="row margin-twenty-zero">
                    ...
                    <div class="form-group filed-left margin-bottom-zero form-filter-field col-xs-12 col-sm-3  nopadding col-lg-2">                    	                    	
                    	
                    	
                    	<?php echo $this->Form->input('role',array('class'=>'form-control selectpicker','data-placeholder'=>'Role','options'=>array(''=>'--Role--',$admin_roles)));?>                    	
                     </div>
                     
					<div class="form-group filed-left margin-bottom-zero clearlefttrespon">
						<?php echo $this->Js->submit('Filter',array('url'=>array('action'=>'manageUsers'),'class'=>'btn btn-sm btn-primary filter-btn form-control','type'=>'submit','update'=>'#content'));?>
					</div>
					<div class="form-group filed-left margin-bottom-zero resetbutton">
						<?php echo $this->Js->link('Reset',array('action'=>'manageUsers'),array('class'=>'btn btn-sm btn-primary filter-btn form-control','update'=>'#content','title'=>'Reset filtered result'));?>
					</div>
                ...
                <table id="sample-table-1" class="table table-striped table-bordered table-hover editable-table ">
					<thead>
						<tr>
							...
							<th>Email</th>
							<th class="hidden-xs"><?php echo $this->Paginator->sort('Aro.alias','Role',array('update'=>'#content'));?></th>
							<th class="hidden-xs"><?php echo $this->Paginator->sort('active','Status',array('update'=>'#content')); ?></th>
							<th>Action</th>
						</tr>
					</thead>
					...
					<tbody>
						...
						<tr id="tr-<?php echo $user['User']['id'];?>">
							...
							<td class="hidden-xs">
								...
								<?php if($permission['_update'] == '1'):?>
									<?php echo $this->Form->input($user['User']['id'].'.aro_id',array('options'=>array($usergroups),'placeholder'=>'Role','data-placeholder'=>'Role','default'=>$user['usergroup_details']['Aro']['id']));?>
								<?php endif;?>
							</td>
							<td class="hidden-xs">
								...
								<div class="visible-xs visible-sm hidden-md hidden-lg">
									<div class="inline position-relative">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
											<li>
												<a class="btn btn-xs btn-success view on-load on-edit" title="View" data-toggle="modal" data-target="#viewuser<?php echo $user['User']['id'];?>">												
													<i class="icon-zoom-in bigger-120"></i>												
												</a>
											</li>
											...
											<li>
												<?php if($permission['_delete'] == '1' && $adminUser['Aro']['foreign_key'] != $user['User']['id']):?>
													<?php echo $this->Html->link('<i class="icon-trash bigger-120"></i>',
																array('action' => 'deleteUser', $user['User']['id']), array('class'=>'btn btn-xs btn-danger delete on-load on-edit','title'=>'Delete','escape'=>FALSE), __('Are you sure want to delete user ?')); ?>
												<?php endif;?>
											</li>
										</ul>
									</div>
      ...
      <div class="modal-body">
         <div class="model-body-inner-content">  
                  ...
                  <div class="form-group login-form-group">
                    ...
                    <div class="col-sm-8 col-sx-11 nopadding fullselect">
                    	<?php echo $this->Form->input('role_id',array('class'=>'selectpicker ','options'=>array(''=>'Select Role',$usergroups)));?>
                    </div>
                  </div>
                  <div class="form-group login-form-group"> 
