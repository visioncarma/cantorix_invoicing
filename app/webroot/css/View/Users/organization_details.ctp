								...
								<div class="widget-main">
									...
									<?php echo $this -> Form -> create('organizationForm',array('url' => array('controller' => 'users', 'action' => 'subscriberDetails'),'id'=>'organizationForm')); ?>
										<fieldset>
											...
											<label class="block clearfix"> <span class="block">
												<?php echo $this->Form->input('time_zone',array('id'=>'form-field-select-1','label'=>false,'class'=>'form-control selectpicker', 'placeholder'=> 'Time Zone', 'options'=>array(''=>'Time Zone',$time_zones),'default'=>$time_zone));?>
											 </span> </label>
