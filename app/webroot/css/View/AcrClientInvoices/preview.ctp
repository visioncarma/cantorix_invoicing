        	...
        	<table cellspacing="0" style="width:600px;padding:0px; background:#fff; height:100%; border:1px solid #d8d8d8; margin:auto; align:center; cellpadding:0; cellspacing:0; bgcolor:#ffffff;">
                ...
                <tr>  
                  <td>
                   <table style="width:70%; height:100%; cellpadding:0; cellspacing:0;" align="center">
                        <tr>
                           <td style="width:33%;font-size:15px;font-family:Arial;text-align:left;padding-left:15px;padding-top: 5px;"><?php echo date($dateFormat,strtotime($data['AcrClientInvoice']['invoiced_date']));?></td>
                           <td style="width:33%;font-size:15px;font-family:Arial;text-align:center;padding-top: 5px;"><?php if($enddate){echo date($dateFormat,strtotime($enddate));}else{echo '--';}?></td> 
                  ...
                  <td>
                   <table style="width:90%; height:100%; cellpadding:0; cellspacing:0;" align="center">
                        <tr>
                           ...
                           <td style="width:16%;font-size:13px;font-family:Arial;border-bottom:1px solid #d8d8d8;text-align:right;padding-right:15px;padding-bottom: 10px;padding-top:10px;"><?php echo $data['AcrClientInvoice']['quantity'][$index];?></td>
