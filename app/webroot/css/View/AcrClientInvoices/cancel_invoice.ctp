...
<td>
	<span class="on-load">
		<?php $options = array('zero'=>'Free','places'=>'2','thousands'=>',','decimals'=>'.','wholeSymbol'=> '','wholePosition'=> 'after');?> 
		<?php echo $this->Number->currency($acrClientInvoice['AcrClientInvoice']['invoice_total'],$acrClientInvoice['AcrClientInvoice']['invoice_currency_code'],$options);?>
	</span>
</td>
<td><span class="on-load "><?php echo $acrClientInvoice['AcrClientInvoice']['status'];?></span>
</td>
<td>
<div class="btn-group">
