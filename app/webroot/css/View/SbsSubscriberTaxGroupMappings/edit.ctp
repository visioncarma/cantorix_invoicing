...
<?php echo $this->Form->create('SbsSubscriberTaxGroupMapping'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sbs Subscriber Tax Group Mapping'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SbsSubscriberTaxGroupMapping.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SbsSubscriberTaxGroupMapping.id'))); ?></li>
