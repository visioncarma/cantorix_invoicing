...
<?php echo $this->Form->create('SbsCurrency'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sbs Currency'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SbsCurrency.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SbsCurrency.id'))); ?></li>
