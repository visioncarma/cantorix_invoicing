<div class="cpnCurrencies form">
<?php echo $this->Form->create('CpnCurrency'); ?>
	<fieldset>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CpnCurrency.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CpnCurrency.id'))); ?></li>
