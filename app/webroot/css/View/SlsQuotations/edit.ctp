...
<?php echo $this->Form->create('SlsQuotation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sls Quotation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SlsQuotation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SlsQuotation.id'))); ?></li>
