 ...
 */
	...
	public function getCustomValues($sls_quotation_id = NULL) {
		return $this->find('list',array('conditions'=>array('sls_quotation_id'=>$sls_quotation_id),'fields'=>array('sls_quotation_custom_field_id','data')));
	}
	
	public function getCustomValueIDs($sls_quotation_id = NULL) {
		return $this->find('list',array('conditions'=>array('sls_quotation_id'=>$sls_quotation_id),'fields'=>array('sls_quotation_custom_field_id','id')));
	}
}
