 ...
 */
	...
	public function getTaxesBySubscriber($subscriber=null){
		$taxList=$this->find('list',array('conditions'=>array('SbsSubscriberTax.sbs_subscriber_id'=>$subscriber),'order'=>array('SbsSubscriberTax.name ASC'),'fields'=>array('SbsSubscriberTax.id','SbsSubscriberTax.name')));
	    return $taxList;
	}
