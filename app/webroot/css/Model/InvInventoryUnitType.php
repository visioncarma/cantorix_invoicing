 ...
 */
	...
	public function getUnitTypeList($subscriberId = null){
		$unitTypeList = $this->find('list',array('conditions'=>array('InvInventoryUnitType.sbs_subscriber_id'=>$subscriberId),'fields'=>array('InvInventoryUnitType.id','InvInventoryUnitType.type_name')));
		return 	$unitTypeList;
	}
