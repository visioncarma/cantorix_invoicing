 ...
 */
	...
	public function getPaymentDetailsById($paymentId = null){
		...
		$payment_details = $this->find('first',array('conditions'=>array('AcrInvoicePaymentDetail.id'=>$paymentId),'fields'=>array('CpnPaymentMethod.payment_option_name','CpnPaymentMethod.id'
	...
	public function getPaymentHistoryForInvoice($invoiceId = null){
		...
		$payment_history = $this->find('all',array('conditions'=>array('AcrInvoicePaymentDetail.acr_client_invoice_id'=>$invoiceId,'AcrInvoicePaymentDetail.is_deleted'=>'no'),'fields'=>array('CpnPaymentMethod.payment_option_name'
		,'AcrInvoicePaymentDetail.payment_date','AcrInvoicePaymentDetail.reference_no','AcrInvoicePaymentDetail.notes','AcrClientInvoice.invoice_number','AcrClientInvoice.status'
	...
	public function getInvoiceIdByPaymentId ($paymentId = null){
		$acr_client_invoice_id = $this->find('first',array('conditions'=>array('AcrInvoicePaymentDetail.id'=>$paymentId),'fields'=>array('AcrInvoicePaymentDetail.acr_client_invoice_id')));
